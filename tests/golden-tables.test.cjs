...
/* The byte-identical golden gate for the ADR-0003 migration.
   ...
   ONE INTENTIONAL CHANGE HAS BEEN MADE SINCE, and it is recorded here rather
   than left for a future reader to find by archaeology. ISSUE 33 widened
