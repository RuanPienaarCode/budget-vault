...
module.exports = {
  ...
  'dash.health.why.intro': '\'n Telling uit 100, uit vyf dele van jou geld. Elke deel is \'n aandeel van die totaal werd. Enigiets wat jou lêers nie kan antwoord nie word uitgelaat, nie nul getel nie.',
  ...
  'dash.health.why.fullReserves': 'Mik vir {target} maande se noodsaaklike uitgawes gespaar.',
  'dash.health.why.fullSaving': 'Mik om {pct}% van wat jy verdien te spaar.',
  'dash.health.why.fullDebt': 'Mik vir geen rente en geen paaiemente nie.',
  'dash.health.why.fullSpending': 'Mik vir vaste rekeninge onder {fixed}% van inkomste, lewenskoste onder {living}%, en besteding binne jou begroting.',
  'dash.health.why.fullWealth': 'Mik dat wat jy besit, min wat jy skuld, {times}× een jaar se inkomste bereik.',
  'dash.health.why.fixTrim': 'Sny lewenskoste met {amount} per maand om onder {pct}% van inkomste te kom.',
  'dash.health.why.fixBuild': 'Laat groei wat jy besit met {amount} om {times}× een jaar se inkomste te bereik.',
  'dash.health.why.points': '{points} uit {max}',
  'dash.health.why.dragLabel': 'Grootste gaping: {name}, {points} punte.',
  'dash.health.why.fixFund': 'Sit {amount} meer in ’n geoormerkte rekening om {target} maande te bereik.',
  'dash.health.why.fixMonthly': 'Spaar {amount} meer per maand om {pct}% te bereik.',
  'dash.health.why.fixInterest': 'Dit is {amount} per maand wat jou niks koop nie — betaal dit af en die punte kom terug.',
