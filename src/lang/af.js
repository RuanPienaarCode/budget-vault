...
module.exports = {
  ...
  'wiz.rates.on.desc': 'Die inprop vra \'n openbare wisselkoersdiens vir die dag se koerse en stoor dit as \'n nota in jou kluis — een keer per dag om mee te begin, wat jy in Instellings na weekliks of maandeliks kan verander. Dit stuur net \'n geldeenheidkode — nooit jou saldo\'s, jou rekeninge of enigiets anders nie. Elke omgeskakelde bedrag word gewys met die datum van sy koers.',
  ...
  'wiz.ccy.euro': '€ — Euro',
  'wiz.ccy.pound': '£ — Pond',
  'wiz.ccy.rupee': '₹ — Indiese Roepee',
  'wiz.ccy.rupiah': 'Rp — Indonesiese Roepia',
  'wiz.ccy.real': 'R$ — Brasiliaanse Real',
  'wiz.ccy.other': 'Ander…',
  ...
  'bx.range.12': '1 jaar',
  'bx.range.all': 'Alles',
  'bx.includeCurrent': 'Sluit die huidige tydperk in',
  'bx.includeCurrent.desc': 'Dit is nog aan die gang, so sy syfers is net vir \'n deel van \'n tydperk. Skakel af om net voltooide tydperke uit te voer.',
  'bx.content': 'Wat om uit te voer',
  'bx.content.full': 'Volledige begroting',
  'bx.content.summary': 'Kategorie-opsomming',
  'bx.content.full.desc': '\'n Maand-tot-maand-opsomming, dan elke tydperk se begroting: wat beplan is, wat bestee is en wat oorgebly het, per kategorie.',
  'bx.content.summary.desc': 'Een tabel: wat elke kategorie in elke tydperk beloop het, met \'n totaal, \'n gemiddelde en die bedrag begroot.',
  'bx.cats': 'Kategorieë',
  'bx.cats.all': 'Alle kategorieë',
  'bx.cats.pick': 'Kies…',
  'bx.cats.selectAll': 'Kies almal',
  'bx.cats.selectNone': 'Kies geeneen',
  'bx.cats.count': '{count} van {total} gekies',
  'bx.includeTx': 'Sluit die transaksies in',
  'bx.includeTx.desc': 'Voeg die individuele transaksies agter die syfers by, vir dieselfde tydperke en kategorieë.',
  'bx.format': 'Lêertipe',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — om te lees, druk of stuur.',
  'bx.format.xlsx.desc': 'Excel — een werkboek met \'n blad per tabel, bedrae as regte getalle.',
  'bx.format.csv.desc': 'CSV — een gewone lêer per tabel, vir \'n ander program.',
  'bx.folder': 'Stoor na vouer',
  'bx.folder.desc': '\'n Vouer in hierdie kluis. Om dieselfde keuse weer uit te voer, vervang dit die vorige lêers.',
  'bx.cancel': 'Kanselleer',
  'bx.go': 'Voer uit',
  'bx.preview': {
  ...
  'bx.dirty': 'Stoor eers jou veranderinge — \'n uitvoer van ongestoorde wysigings sal nie by die kluis pas nie',
  'bx.failed': 'Kon nie die uitvoer skryf nie ({error}) — kyk na die vouernaam',
  'bx.failedPartial': {
    one: 'Die uitvoer het gestop na {count} lêer ({error})',
    other: 'Die uitvoer het gestop na {count} lêers ({error})',
  },
  'bx.done': {
    one: '{count} lêer na {path}/ uitgevoer',
    other: '{count} lêers na {path}/ uitgevoer',
  },
  'bx.done.title': 'Begroting uitgevoer',
  'bx.done.open': 'Maak oop',
  'bx.done.reveal': 'Wys in lêerverkenner',
  'bx.done.close': 'Klaar',
  'bx.done.hint': 'Die lêers is in jou kluis. Om een te stuur, maak dit oop of vind dit in die lêerverkenner en gebruik jou toestel se deel- of stoor-opsie.',
  'bx.done.raster': 'Sommige teks in hierdie uitvoer gebruik karakters wat die ingeboude PDF-lettertipe nie kan teken nie, so die PDF-bladsye is as beelde gestoor. Dit lyk dieselfde, maar die teks kan nie gekies of deursoek word nie. Die Excel- en CSV-lêers word nie geraak nie.',
  'bx.doc.title': 'Begroting',
  'bx.doc.titleSummary': 'Begrotingopsomming',
  'bx.doc.category': 'Kategorie',
  'bx.doc.type': 'Tipe',
  'bx.doc.total': 'Totaal',
  'bx.doc.average': 'Gemiddeld',
  'bx.doc.budgeted': 'Begroot',
  'bx.doc.period': 'Tydperk',
  'bx.doc.from': 'Van',
  'bx.doc.to': 'Tot',
  'bx.doc.budget': 'Begroting',
  'bx.doc.actual': 'Werklik',
  'bx.doc.remaining': 'Oorblywend',
  'bx.doc.used': 'Gebruik',
  'bx.doc.notes': 'Notas',
  'bx.doc.date': 'Datum',
  'bx.doc.description': 'Beskrywing',
  'bx.doc.account': 'Rekening',
  'bx.doc.currency': 'Geldeenheid',
  'bx.doc.amount': 'Bedrag',
  'bx.doc.flag': 'Vlag',
  'bx.doc.excluded': 'uitgesluit',
  'bx.doc.splitParent': 'verdeeloorsprong',
  'bx.doc.splitPart': 'verdeeldeel',
  'bx.doc.subtotal': 'Totaal {type}',
  'bx.doc.summaryHeading': 'Opsomming per kategorie',
  'bx.doc.transactionsHeading': 'Transaksies',
  'bx.doc.generated': 'Gegenereer',
  'bx.doc.range': 'Tydperk',
  'bx.doc.categories': 'Kategorieë',
  'bx.doc.allCategories': 'Alle kategorieë',
  'bx.doc.periodLine': 'Inkomste {income} · Bestee {spend}',
  'bx.doc.periodUncat': ' · Ongekategoriseer {uncat}',
  'bx.doc.noteFilter': 'Slegs hierdie kategorieë is ingesluit: {list}. Totale dek die gelyste kategorieë, nie die hele begroting nie.',
  'bx.doc.noteForeign': 'Rekeninge in {list} is nie in enige syfer hier ingesluit nie — daar is geen wisselkoers in hierdie lêer om hulle mee te kombineer nie.',
  ...
  'acct.balance.impliedHint': { one: 'Jou transaksies tel op tot {amount} — {count} daarvan sedert jy laas bevestig het.', other: 'Jou transaksies tel op tot {amount} — {count} daarvan sedert jy laas bevestig het.' },
  ...
  'acct.balance.updatedDrift': { one: 'Saldo van {name} is gestoor — maar {count} transaksie sedertdien tel op tot {amount} meer of minder as die syfer wat jy gestoor het. Maak die rekening oop om dit te sien.', other: 'Saldo van {name} is gestoor — maar {count} transaksies sedertdien tel op tot {amount} meer of minder as die syfer wat jy gestoor het. Maak die rekening oop om hulle te sien.' },
  'acct.balance.unreadable': 'Kon nie "{raw}" lees nie — tik om reg te maak',
  'acct.reconciled': 'Saldo van {name} op {amount} gestel — stem ooreen met jou transaksies',
  'acct.toast.updated': '{name} bygewerk',
  'acct.deck.ignore': 'Ignoreer',
  'acct.deck.ariaIgnore': 'Ignoreer hierdie waarskuwing op {name}',
  'acct.toast.ignored': '{name}: hierdie waarskuwing word nou geïgnoreer. Maak dit ongedaan onder Wysig.',
  'acct.toast.created': '{path} geskep',
  ...
  'acct.mute.drift': 'Saldo stem nie met die transaksies ooreen nie',
  ...
  'acct.counts.no': 'Nee — spaar- of beleggingsrekening',
  ...
  'acct.emergency.part': 'Hou {amount} opsy',
  'acct.field.limit': 'Kredietperk',
  'acct.field.limitDesc': 'Wys hoeveel van die limiet gebruik is, op kredietkaarte.',
  ...
  'report.debt.otherCurrencies': ' Plus {list} verskuldig in ander geldeenhede, nie omgeskakel nie.',
  ...
  'settings.exchangeRates.on': 'Aan — haal wisselkoerse',
  'settings.exchangeRates.desc': 'Standaard af, en die enigste ding in hierdie inprop wat \'n netwerkversoek maak. Aangeskakel vra dit \'n openbare wisselkoersdiens vir die dag se koerse so gereeld soos jy hieronder kies, stoor dit as \'n leesbare nota in jou begrotingsvouer, en tel rekeninge in ander geldeenhede by jou totale. Dit stuur net \'n geldeenheidkode — nooit jou saldo\'s of rekeningname nie. Elke omgeskakelde bedrag word gedruk met die datum van sy koers, en \'n koers ouer as \'n week sê so.',
  'settings.rateRefresh.name': 'Hoe gereeld om koerse te haal',
  'settings.rateRefresh.desc': 'Hoe gereeld die inprop nuwe koerse mag vra, wanneer wisselkoerse hierbo aan is. Daagliks is wat dit nog altyd belowe het. Weekliks of maandeliks beteken minder versoeke — elke omgeskakelde bedrag druk steeds die datum van sy koers, so \'n koers wat jy gekies het om selde te haal, sê steeds hoe oud dit is.',
  'settings.rateRefresh.daily': 'Daagliks',
  ...
  'acct.deck.show': "Wys hulle",
  'acct.deck.groupReason.drift': "Die saldo stem nie ooreen met die transaksies nie",
  'acct.deck.groupReason.stale': "Die saldo is al 'n rukkie nie bevestig nie",
  'acct.deck.groupReason.unreadable': "Sommige transaksies het 'n datum wat niks kan lees nie",
  'acct.deck.groupReason.nodate': "Die saldo het geen leesbare bevestigingsdatum nie",
  'acct.deck.groupReason.notx': "'n Vouer is gekoppel, maar niks is nog daarin ingevoer nie",
  'acct.deck.groupReason.nofolder': "Niks voer in hierdie rekeninge in nie, so niks kan die syfer nagaan nie",
  ...
  'acct.state.drift': 'stem nie ooreen nie',
  'acct.state.unreadable': 'datum onleesbaar',
  ...
  'acct.drawer.recon.stale': 'Laas bevestig {date}. Bevestig dit en die nagaan begin vandag van voor af.',
  'acct.drawer.recon.nodate': 'Nog geen bevestigde datum nie — stel een en hierdie syfer kan teen jou transaksies nagegaan word.',
  ...
  'acct.drawer.recon.unreadable': 'Hierdie syfer kan nog nie teen jou transaksies nagegaan word nie.',
  ...
  'dash.hero.assumedIncluded': 'sluit {amount} in wat reeds bestee is',
  'dash.hero.nettedOff': '{amount} aan terugbetalings verreken',
  ...
  'dash.stat.allocated': '{pct}% van die inkomste begroot',
  'dash.stat.allocatedOf': '{pct}% van die {amount} inkomste wat hierdie begroting beplan',
  'dash.stat.setAside': '{amount} opsy gesit',
  'dash.stat.setAsideMoved': '{amount} opsy gesit, {moved} reeds geskuif',
  ...
  'dash.fundedFromSavings': {
    ...
    other: '{amount} meer het uit jou fondse gegaan ({count} transaksies), wat hierdie begroting nie tel nie',
  },
  'dash.stat.used': '{pct}% gebruik',
  'dash.stat.review': 'gaan na in Transaksies',
  'dash.stat.notIncome': '{amount} het ingekom sonder kategorie — nie hier getel nie',
  ...
  'dash.stale.driftUp': ' Transaksies sedertdien tel op tot {amount} meer.',
  'dash.stale.driftDown': ' Transaksies sedertdien tel op tot {amount} minder.',
  ...
  'dash.split.setAsideNote': ' · {amount} opsy gesit',
  ...
  'dash.health.meterTip': {
    one: '{earmarked} opsy gesit van die {goal} wat {count} maand dek',
    other: '{earmarked} opsy gesit van die {goal} wat {count} maande dek',
  },
  'dash.health.monthsMeta': {
    one: 'Doel {count} maand · {amount} opsy gesit',
    other: 'Doel {count} maande · {amount} opsy gesit',
  },
  ...
  'dash.health.noEssential': 'geen noodsaaklike besteding aangeteken om teen te meet nie',
  'dash.health.over': '{name} is aangewys om meer opsy te sit as wat dit werklik hou',
  'dash.health.savings': 'van inkomste gespaar, gemiddeld',
  'dash.health.savingDown': 'gemiddeld {amount} per maand kom uit',
  'dash.health.perMonth': '{amount} / maand',
  'dash.health.debt': 'van inkomste aan skuldrente, gemiddeld',
  ...
  'score.win.wealth': 'Wat jy besit het ver verby wat jy skuld gegroei. Dit is die deel wat stilweg vanself groei.',
  ...
  'score.now.saving': 'Gemiddeld {pct} van inkomste gespaar · {amount} per maand oor onlangse tydperke — eenmalige meevallers tel, en vervaag soos hulle verouder',
  'score.now.savingDown': 'Gemiddeld {amount} per maand oor onlangse tydperke uit spaargeld onttrek, nie bygevoeg nie',
  'score.now.debt': 'Gemiddeld gaan {pct} van inkomste na rente oor onlangse tydperke',
  'score.now.fixed': 'vaste rekeninge {pct} van inkomste',
  'score.now.living': 'lewenskoste {pct}',
  'score.now.budget': 'begroting gebruik {pct}',
  'score.now.wealth': 'Nou: {amount} netowaarde · gelykstaande aan {times} jaar se inkomste',
  ...
  'score.flow.overspent.name': "Oorbestee",
  'score.flow.overspent.sub': "Jy het {amount} meer bestee as wat ingekom het",
  ...
  'score.flow.subA.overBudget': "{amount} oor die begroting · {neverBudgeted} nooit begroot nie",
  ...
  'score.flow.chip.ofWhichInterest': 'rente daarin',
  ...
  'score.flow.chip.allocatedOfIncome': 'Aandeel van inkomste begroot',
  'score.flow.chip.spent': 'Bestee',
  'score.flow.chip.budgetUsed': 'Begroting gebruik hierdie tydperk',
  'score.flow.chip.budgetUsedNote': 'Slegs hierdie tydperk — die telling hierbo gebruik die gemiddeld oor ses tydperke.',
  'score.flow.chip.lefts': 'Geld oor — twee soorte',
  ...
  'dash.left.earmarked': 'opsy gesit',
  'dash.left.earmarkedFrom': { one: '{count} fonds', other: '{count} fondse', },
  ...
  'dash.left.confirmDay': {
    one: '{count} ry op ’n bevestigingsdatum ({amount}) is reeds in hierdie saldo’s',
    other: '{count} rye op ’n bevestigingsdatum ({amount}) is reeds in hierdie saldo’s',
  },
  'dash.left.orders': {
  ...
  'dash.left.instalments': {
    one: '{count} skuldterugbetaling',
    other: '{count} skuldterugbetalings',
  },
  'dash.left.cards': {
  ...
  'dash.left.barAriaSetAside': 'Van {cash} is {earmarked} opsy gesit, {committed} verbind en {free} beskikbaar',
  ...
  'dash.left.overdue': 'was betaalbaar {date}',
  ...
  'nav.report': 'Verslag',
  'shell.tx.report': 'Verslag',
  'report.pageSub': 'Een Markdown-nota · lees dit in Obsidian, deel dit, of plak dit in \'n KI-gesprek',
  'report.options.title': 'Verslagopsies',
  'report.field.period': 'Tydperk',
  'report.field.detail': 'Detail',
  'report.field.format': 'Formaat',
  'report.field.folder': 'Vouer',
  'report.field.folderDesc': 'Waar die nota geskryf word — onthou vir volgende keer.',
  'report.field.folderManaged': 'Dit is binne {folder}, \'n vouer wat hierdie app bestuur — \'n verslag wat hier gestoor word, sal die volgende keer as data (byvoorbeeld \'n nuwe kategorie) teruggelees word. Kies \'n ander vouer.',
  'report.period.current': 'Huidige maand',
  'report.period.current.desc': 'Net hierdie begrotingstydperk.',
  'report.period.3m': 'Laaste 3 maande',
  'report.period.3m.desc': 'Die laaste 3 maande, of minder as die kluis nie so ver terugstrek nie.',
  'report.period.12m': 'Laaste 12 maande',
  ...
  'report.format.md.desc': 'Lees dit in Obsidian, deel dit, of open dit as \'n PDF vanaf die rekenaarprogram.',
  'report.format.json': 'JSON',
  'report.format.json.desc': 'Rou syfers en \'n geldeenheidkode, vir \'n nutsprogram wat eerder wil ontleed as lees.',
  'report.format.pillsAria': 'Verslaglêerformaat',
  'report.to': 'tot',
  'report.preview': 'Sal skep: {path}',
  'report.exists': 'Bestaan reeds vir hierdie keuse ({formats}) — om weer te skep oorskryf dit.',
  'report.create': 'Skep verslag',
  'report.recreate': 'Skep verslag oor (oorskryf)',
  'report.contains.title': 'Hierdie verslag sal insluit:',
  'report.contains.incomeSpend': 'Inkomste teenoor besteding',
  'report.contains.category': 'Besteding per kategorie',
  'report.contains.budget': 'Begroting teenoor werklik',
  'report.contains.savings': 'Spaar- en beleggingsgroei (tans)',
  'report.contains.debt': 'Skuldposisie (tans)',
  'report.contains.netWorth': 'Netto waarde (tans)',
  'report.contains.health': 'Finansiële gesondheidstelling (tans), indien daar genoeg geskiedenis is',
  'report.contains.transactions': 'Elke transaksie in die tydperk, gelys',
  'report.created': 'Verslag geskep',
  'report.createdPartial': 'Verslag gedeeltelik geskep — een lêer het misluk ({error})',
  'report.createFailed': 'Kon nie die verslag skep nie ({error})',
  'report.result.title': 'Verslag gereed',
  'report.result.generated': 'Geskep {date}',
  'report.result.found': 'Reeds op skyf vanaf \'n vorige verslag',
  'report.open': 'Open verslag',
  'report.openFailed': 'Kon nie daardie verslag open nie — die lêer het dalk geskuif',
  'report.copy': 'Kopieer vir KI',
  'report.copyJson': 'Kopieer JSON',
  'report.copied': 'Na knipbord gekopieer',
  'report.copyFailed': 'Kon nie die verslag kopieer nie ({error})',
  'report.shareHint': 'Om dit op \'n ander manier te stuur, open die nota en gebruik Obsidian se eie deel-kieslys.',
  ...
  'report.col.budgetIncome': 'Begrote inkomste',
  'report.col.budgetSpend': 'Begrote besteding',
  'report.section.category': 'Besteding per Kategorie',
  ...
  'report.category.scheduled': {
    one: '{count} transaksie later in hierdie tydperk gedateer ({amount}) word hieronder gelys maar nie in die totale hierbo getel nie.',
    other: '{count} transaksies later in hierdie tydperk gedateer ({amount}) word hieronder gelys maar nie in die totale hierbo getel nie.',
  },
  'report.health.otherCurrencies': 'Hierdie telling is bereken sonder {list}.',
  ...
  'report.col.amount': 'Bedrag',
  'report.col.percent': '%',
  'report.section.budgetActual': 'Begroting teenoor Werklik',
  'report.budget.empty': 'Geen begroting of besteding aangeteken vir hierdie tydperk nie.',
  'report.col.type': 'Tipe',
  'report.col.budget': 'Begroting',
  'report.col.actual': 'Werklik',
  'report.col.remaining': 'Oorblywend',
  'report.section.savings': 'Spaar- en Beleggingsgroei',
  'report.asOf': '_Tans — nie beperk tot bostaande tydperk nie; sien die nota onder hierdie opskrif in die program._',
  'report.savings.none': 'Geen spaar- of beleggingsrekeninge aangeteken nie.',
  'report.savings.unmeasured': 'Geen spaar- of beleggingsrekening het \'n beginbedrag of aanvangsdatum gestel nie, so groei kan nog nie gemeet word nie.',
  ...
  'report.debt.free': {
    one: 'Skuldvry — {count} skuld nagespoor, afbetaal.',
    other: 'Skuldvry — {count} skulde nagespoor, almal afbetaal.',
  },
  ...
  'report.col.interest': 'Maandelikse rente',
  'report.section.netWorth': 'Netto Waarde',
  'report.col.netWorth': 'Netto waarde',
  'report.col.owned': 'Besit',
  'report.col.owed': 'Verskuldig',
  'report.section.health': 'Finansiële Gesondheid',
  'report.health.score': 'Telling',
  ...
  'assets.hero.totalLabel': "Totale waarde",
  'assets.hero.items': { one: "{count} item", other: "{count} items" },
  'assets.hero.largest': "grootste",
  'assets.hero.badgeOk': "elke waarde op datum",
  'assets.hero.badgeWarn': { one: "{count} het 'n nuwe waardasie nodig", other: "{count} het 'n nuwe waardasie nodig" },
  'assets.hero.heldAbroad': "plus {list} in die buiteland gehou, nie omgeskakel nie",
  'assets.hero.largestAbroad': "grootste in die buiteland {list}, nie omgeskakel nie",

  /* ------------------------- plan view (mobile redesign) ------------------------- */
  'plan.hero.leftToPlace': "Oor om te plaas",
  'plan.hero.overPlaced': "Meer geplaas as wat hierdie plan hou",
  'plan.hero.overSpent': "Meer bestee as wat hierdie plan hou",
  'plan.hero.ofPot': "van {pot} in hierdie plan",
  'plan.hero.allIn': "alles daarvan is vandag in die rekening",
  'plan.hero.noneIn': "niks daarvan het nog aangekom nie",
  'plan.hero.partial': "{received} is vandag in die rekening, {expected} word nog verwag",
  'plan.hero.noSources': "Nog geen bronne nie — voeg by wat hierdie plan befonds.",
  'plan.split.spokenFor': "Reeds toegewys",
  'plan.split.notSpokenFor': "Nog nie toegewys nie",
  'plan.split.alreadySpent': "Reeds bestee",
  'plan.split.overspent': "Oorbestee",
  'plan.split.stillLeft': "Nog oor om te bestee",
  'plan.source.editAria': "Wysig bron {name}",
  'plan.source.removeAria': "Verwyder bron {name}",
  'plan.source.inAccount': "in die rekening",
  'plan.source.expected': "verwag",
  'plan.source.noDate': "Geen datum",
  'plan.source.fieldName': "Wat is dit?",
  'plan.source.fieldKind': "Soort",
  'plan.source.fieldKindDesc': "Slegs 'n etiket vir groepering — dit verander niks aan die rekenkunde nie.",
  'plan.source.fieldAmount': "Bedrag",
  'plan.source.fieldDate': "Wanneer land dit?",
  'plan.source.fieldDateDesc': "'n Datum in die toekoms tel teenoor die plan, maar nie teenoor wat jy vandag kan bestee nie.",
  'plan.source.fieldStatus': "Status",
  'plan.source.statusReceived': "ontvang",
  'plan.source.statusExpected': "verwag",
  'plan.source.fieldNotes': "Notas",
  'plan.source.fieldRemove': "Verwyder hierdie bron",
  'plan.source.fieldRemoveYes': "Verwyder dit",
  'plan.env.expandAria': "Brei {name} uit",
  'plan.env.leftInBucket': "{amount} oor",
  'plan.env.allSpent': "alles bestee",
  'plan.env.nothingSpent': "nog niks bestee nie",
  'plan.env.collapseAria': "Vou {name} toe",
  'plan.env.deleteAria': "Verwyder bestedingsbak {name}",
  'plan.actions.deleteAria': "Verwyder plan",
