...
module.exports = {
  ...
  'dash.health.months': 'maande se noodsaaklike uitgawes gedek',
  'dash.health.monthsMeta': 'teiken {target} · {amount} geoormerk',
  ...
  'dash.health.why.intro': 'Een syfer uit 100, uit vyf dele van jou finansies. Elke deel is \'n aandeel van die totaal werd, en jy verdien sy punte na verhouding van hoe naby jy aan volpunte is. \'n Deel wat jou lêers nie kan antwoord nie word uitgelaat eerder as nul getel.',
  'dash.health.why.bands': '{strong} en hoër is sterk · {steady}–{strongLess} is bestendig · onder {steady} benodig aandag',
  ...
  'dash.health.why.fullReserves': 'Volpunte met {target} maande se noodsaaklike uitgawes eenkant gesit.',
  'dash.health.why.fullSaving': 'Volpunte wanneer {pct}% van jou inkomste gespaar word.',
  'dash.health.why.fullDebt': 'Volpunte wanneer niks na rente gaan nie en daar geen paaiemente is nie.',
  'dash.health.why.fullSpending': 'Volpunte met minder as {fixed}% van inkomste vasgelê in vaste koste, lewenskoste onder {living}%, en besteding binne jou begroting.',
  'dash.health.why.fullWealth': 'Volpunte by \'n netowaarde van {times}× jou jaarlikse inkomste — alles wat jy besit, min alles wat jy skuld.',
  'dash.health.why.fixTrim': 'Om lewenskoste met {amount} per maand te verlaag sou dit onder {pct}% van inkomste bring.',
  'dash.health.why.fixBuild': 'Nog {amount} se netowaarde sou {times}× jou jaarlikse inkomste bereik.',
  'dash.health.why.points': '{points} uit {max}',
  'dash.health.why.dragLabel': 'Kos jou die meeste: {name}, {points} punte.',
  'dash.health.why.fixFund': 'Om {amount} by \'n geoormerkte rekening te voeg sou {target} maande bereik en daardie punte terugverdien.',
  'dash.health.why.fixMonthly': 'Nog {amount} per maand in spaargeld sou {pct}% bereik en daardie punte terugverdien.',
  'dash.health.why.fixInterest': 'Dit is {amount} per maand wat jou niks koop nie — elke rand daarvan wat jy afbetaal kom terug as punte.',
  'dash.health.why.allFull': 'Elke deel wat gemeet kan word is op volpunte. Niks hier hou jou terug nie.',
