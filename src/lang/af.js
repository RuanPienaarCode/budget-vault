...
module.exports = {
  ...
  'dash.health.why.title': 'Hoe hierdie telling werk',
  'dash.health.why.intro': 'Jou telling uit 100, opgebou uit vyf dele van jou geld. Enigiets wat jou lêers nie kan wys nie word eenvoudig uitgelaat — dit tel nooit teen jou nie.',
  ...
  'dash.health.why.fullReserves': 'Geld wat vir noodgevalle opsy gesit is. Volpunte wanneer dit {target} maande se moet-betaal-koste (huur, kos, vervoer) kan dek as jou inkomste ophou.',
  'dash.health.why.fullSaving': 'Hoeveel van jou inkomste jy wegsit. Volpunte wanneer jy elke maand {pct}% van wat jy verdien spaar.',
  'dash.health.why.fullDebt': 'Wat jou skuld jou kos. Volpunte wanneer jy geen rente betaal nie en geen lening- of kaartpaaiemente het nie.',
  'dash.health.why.fullSpending': 'Hoe jou besteding met jou inkomste vergelyk. Volpunte wanneer vaste rekeninge (huur, versekering, intekeninge) onder {fixed}% neem, alle daaglikse lewenskoste onder {living}% neem, en jy binne jou begroting bly.',
  'dash.health.why.fullWealth': 'Alles wat jy besit (spaargeld, beleggings, eiendom) minus alles wat jy skuld (lenings, kaarte). Volpunte wanneer dit {times} jaar se inkomste beloop.',
  ...
  'dash.health.why.dragLabel': 'Grootste gaping: {name}, {points} punte.',
  ...
  'dash.health.why.allFull': 'Alles wat ons kan meet is op volpunte. Niks hou jou terug nie.',
  'dash.health.why.aria': 'Finansiële telling — hoe dit bereken word en wat dit sou verbeter',
  ...
  'score.how.title': 'Hoe die telling opgebou word',
  'score.how.sub': 'Vyf dele, elk ’n aandeel van 100',
  'score.how.worth': '{points} werd',
