...
module.exports = {
  ...
  'wiz.folder.notVault': 'Ein Ordner in diesem Vault — kein eigener Vault. Ihn als eigenen Vault zu öffnen, blendet das Plugin aus.',
  ...
  'wiz.rates.on.desc': 'Das Plugin fragt einen öffentlichen Wechselkursdienst nach den Kursen des Tages und speichert sie als Notiz in Ihrem Tresor — zunächst einmal täglich, was Sie in den Einstellungen auf wöchentlich oder monatlich ändern können. Es sendet nur einen Währungscode — niemals Ihre Salden, Ihre Konten oder sonst etwas. Jeder umgerechnete Betrag wird mit dem Datum seines Kurses angezeigt.',
  ...
  'wiz.ccy.euro': '€ — Euro',
  'wiz.ccy.pound': '£ — Pfund',
  'wiz.ccy.rupee': '₹ — Indische Rupie',
  'wiz.ccy.rupiah': 'Rp — Indonesische Rupiah',
  'wiz.ccy.real': 'R$ — Brasilianischer Real',
  ...
  'bx.range.12': '1 Jahr',
  'bx.range.all': 'Alles',
  'bx.includeCurrent': 'Aktuellen Zeitraum einbeziehen',
  'bx.includeCurrent.desc': 'Er läuft noch, daher gelten seine Zahlen nur für einen Teil eines Zeitraums. Schalte dies aus, um nur abgeschlossene Zeiträume zu exportieren.',
  'bx.content': 'Was exportiert werden soll',
  'bx.content.full': 'Vollständiges Budget',
  'bx.content.summary': 'Kategorienübersicht',
  'bx.content.full.desc': 'Eine Monat-für-Monat-Übersicht, dann das Budget jedes Zeitraums: was geplant war, was ausgegeben wurde und was übrig blieb, pro Kategorie.',
  'bx.content.summary.desc': 'Eine Tabelle: was jede Kategorie in jedem Zeitraum ausmachte, mit Gesamtsumme, Durchschnitt und budgetiertem Betrag.',
  'bx.cats': 'Kategorien',
  'bx.cats.all': 'Alle Kategorien',
  'bx.cats.pick': 'Auswählen…',
  'bx.cats.selectAll': 'Alle auswählen',
  'bx.cats.selectNone': 'Keine auswählen',
  'bx.cats.count': '{count} von {total} ausgewählt',
  'bx.includeTx': 'Transaktionen einbeziehen',
  'bx.includeTx.desc': 'Fügt die einzelnen Transaktionen hinter den Zahlen hinzu, für dieselben Zeiträume und Kategorien.',
  'bx.format': 'Dateityp',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — zum Lesen, Drucken oder Versenden.',
  'bx.format.xlsx.desc': 'Excel — eine Arbeitsmappe mit einem Blatt pro Tabelle, Beträge als echte Zahlen.',
  'bx.format.csv.desc': 'CSV — eine einfache Datei pro Tabelle, für ein anderes Programm.',
  'bx.folder': 'In Ordner speichern',
  'bx.folder.desc': 'Ein Ordner in diesem Vault. Der erneute Export derselben Auswahl ersetzt die vorherigen Dateien.',
  'bx.cancel': 'Abbrechen',
  'bx.go': 'Exportieren',
  'bx.preview': {
  ...
  'bx.dirty': 'Speichere zuerst deine Änderungen — ein Export ungespeicherter Bearbeitungen würde nicht zum Vault passen',
  'bx.failed': 'Der Export konnte nicht geschrieben werden ({error}) — prüfe den Ordnernamen',
  'bx.failedPartial': {
    one: 'Der Export wurde nach {count} Datei abgebrochen ({error})',
    other: 'Der Export wurde nach {count} Dateien abgebrochen ({error})',
  },
  'bx.done': {
    one: '{count} Datei nach {path}/ exportiert',
    other: '{count} Dateien nach {path}/ exportiert',
  },
  'bx.done.title': 'Budget exportiert',
  'bx.done.open': 'Öffnen',
  'bx.done.reveal': 'Im Dateiexplorer anzeigen',
  'bx.done.close': 'Fertig',
  'bx.done.hint': 'Die Dateien befinden sich in deinem Vault. Um eine zu versenden, öffne sie oder finde sie im Dateiexplorer und nutze die Teilen- oder Speichern-Funktion deines Geräts.',
  'bx.done.raster': 'Ein Teil des Texts in diesem Export verwendet Zeichen, die die eingebaute PDF-Schrift nicht darstellen kann, daher wurden die PDF-Seiten als Bilder gespeichert. Es sieht gleich aus, aber der Text kann nicht ausgewählt oder durchsucht werden. Die Excel- und CSV-Dateien sind davon nicht betroffen.',
  'bx.doc.title': 'Budget',
  'bx.doc.titleSummary': 'Budgetübersicht',
  'bx.doc.category': 'Kategorie',
  'bx.doc.type': 'Typ',
  'bx.doc.total': 'Gesamt',
  'bx.doc.average': 'Durchschnitt',
  'bx.doc.budgeted': 'Budgetiert',
  'bx.doc.period': 'Zeitraum',
  'bx.doc.from': 'Von',
  'bx.doc.to': 'Bis',
  'bx.doc.budget': 'Budget',
  'bx.doc.actual': 'Tatsächlich',
  'bx.doc.remaining': 'Verbleibend',
  'bx.doc.used': 'Verbraucht',
  'bx.doc.notes': 'Notizen',
  'bx.doc.date': 'Datum',
  'bx.doc.description': 'Beschreibung',
  'bx.doc.account': 'Konto',
  'bx.doc.currency': 'Währung',
  'bx.doc.amount': 'Betrag',
  'bx.doc.flag': 'Markierung',
  'bx.doc.excluded': 'ausgeschlossen',
  'bx.doc.splitParent': 'Aufteilungsursprung',
  'bx.doc.splitPart': 'Aufteilungsteil',
  'bx.doc.subtotal': 'Gesamt {type}',
  'bx.doc.summaryHeading': 'Übersicht nach Kategorie',
  'bx.doc.transactionsHeading': 'Transaktionen',
  'bx.doc.generated': 'Erstellt',
  'bx.doc.range': 'Zeitraum',
  'bx.doc.categories': 'Kategorien',
  'bx.doc.allCategories': 'Alle Kategorien',
  'bx.doc.periodLine': 'Einnahmen {income} · Ausgaben {spend}',
  'bx.doc.periodUncat': ' · Nicht kategorisiert {uncat}',
  'bx.doc.noteFilter': 'Nur diese Kategorien sind enthalten: {list}. Die Summen decken die aufgelisteten Kategorien ab, nicht das gesamte Budget.',
  'bx.doc.noteForeign': 'Konten in {list} sind in keiner Zahl hier enthalten — es gibt keinen Wechselkurs in dieser Datei, um sie damit zu kombinieren.',
  ...
  'acct.deck.ignore': 'Ignorieren',
  'acct.deck.ariaIgnore': 'Diese Warnung bei {name} ignorieren',
  'acct.toast.ignored': '{name}: Diese Warnung wird jetzt ignoriert. Rückgängig unter Bearbeiten.',
  ...
  'acct.badge.currencyClash': 'wird als {code} gelesen, nicht als {symbol}',
  'acct.drawer.currencyClash': 'Währungskonflikt',

  'acct.recon.pending': {
    one: ' · {count} in der Zukunft datiert, noch nicht gezählt',
    other: ' · {count} in der Zukunft datiert, noch nicht gezählt',
  },
  'acct.recon.undatable': { one: ' · {count} Transaktion mit einem Datum, das diese App nicht lesen kann — in keinem der beiden Zeitfenster', other: ' · {count} Transaktionen mit Daten, die diese App nicht lesen kann — in keinem der beiden Zeitfenster' },
  ...
  'acct.hero.converted': ' Zuzüglich {list} — oben umgerechnet zu Kursen vom {date}.',
  'acct.hero.convertedTotal': 'Umgerechnete Summe {amount}',
  'acct.hero.convertedStale': ' Zuzüglich {list} — oben umgerechnet zu Kursen vom {date}, {days} Tage alt.',
  'acct.hero.otherCurrencies': ' Plus {list} in anderen Währungen, nicht umgerechnet.',
  'report.debt.otherCurrencies': ' Plus {list} geschuldet in anderen Währungen, nicht umgerechnet.',
  ...
  'settings.exchangeRates.on': 'Ein — Wechselkurse holen',
  'settings.exchangeRates.desc': 'Standardmäßig aus, und das Einzige in diesem Plugin, das eine Netzwerkanfrage stellt. Eingeschaltet fragt es einen öffentlichen Wechselkursdienst so oft, wie Sie unten wählen, nach den Kursen des Tages, speichert sie als lesbare Notiz in Ihrem Budget-Ordner und zählt Konten in anderen Währungen zu Ihren Summen. Es sendet nur einen Währungscode — niemals Ihre Salden oder Kontonamen. Jeder umgerechnete Betrag wird mit dem Datum seines Kurses gedruckt, und ein Kurs, der älter als eine Woche ist, sagt das.',
  'settings.rateRefresh.name': 'Wie oft Kurse geholt werden',
  'settings.rateRefresh.desc': 'Wie oft das Plugin neue Kurse anfragen darf, wenn Wechselkurse oben eingeschaltet sind. Täglich ist das, was es immer versprochen hat. Wöchentlich oder monatlich bedeutet weniger Anfragen — jeder umgerechnete Betrag nennt weiterhin das Datum seines Kurses, ein selten geholter Kurs sagt also trotzdem, wie alt er ist.',
  'settings.rateRefresh.daily': 'Täglich',
  'settings.rateRefresh.weekly': 'Wöchentlich',
  'settings.rateRefresh.monthly': 'Monatlich',
  ...
  'acct.deck.why.unreadable': { one: '{count} Transaktion trägt ein Datum, das diese App nicht lesen kann — der Kontostand lässt sich nicht dagegen prüfen', other: '{count} Transaktionen tragen Daten, die diese App nicht lesen kann — der Kontostand lässt sich nicht dagegen prüfen' },
  ...
  'acct.deck.show': "Zeigen",
  'acct.deck.groupReason.drift': "Der Kontostand stimmt nicht mit den Transaktionen überein",
  'acct.deck.groupReason.stale': "Der Kontostand wurde eine Weile nicht bestätigt",
  'acct.deck.groupReason.unreadable': "Manche Transaktionen tragen ein Datum, das nichts lesen kann",
  'acct.deck.groupReason.nodate': "Der Kontostand hat kein lesbares Bestätigungsdatum",
  'acct.deck.groupReason.notx': "Ein Ordner ist verknüpft, aber es wurde noch nichts importiert",
  'acct.deck.groupReason.nofolder': "In diese wird nichts importiert, also kann nichts den Stand prüfen",
  ...
  'acct.state.unreadable': 'Datum unlesbar',
  ...
  'acct.drawer.recon.unreadable': 'Dieser Stand lässt sich noch nicht mit deinen Umsätzen abgleichen.',
  ...
  'acct.drawer.ahead': 'Noch ausstehend',
  'acct.drawer.aheadRows': { one: '{count} Buchung mit späterem Datum in dieser Periode', other: '{count} Buchungen mit späterem Datum in dieser Periode', },
  ...
  'dash.hero.assumedIncluded': 'enthält {amount} bereits ausgegeben',
  'dash.hero.nettedOff': '{amount} an Erstattungen verrechnet',
  ...
  'dash.stat.allocatedOf': '{pct}% der {amount} Einnahmen, mit denen dieses Budget plant',
  'dash.stat.setAside': '{amount} zurückgelegt',
  'dash.stat.setAsideMoved': '{amount} zurückgelegt, {moved} bisher bewegt',
  ...
  'dash.fundedFromSavings': {
    ...
    other: '{amount} mehr ging aus Ihren Rücklagen ({count} Buchungen) und zählt in diesem Budget nicht mit',
  },
  ...
  'dash.split.setAsideNote': ' · {amount} zurückgelegt',
  ...
  'score.flow.overspent.name': "Überzogen",
  'score.flow.overspent.sub': "Du hast {amount} mehr ausgegeben, als eingegangen ist",
  ...
  'score.flow.subA.overBudget': "{amount} über dem Budget · {neverBudgeted} nie budgetiert",
  ...
  'dash.left.earmarked': 'zurückgelegt',
  'dash.left.earmarkedFrom': { one: '{count} Rücklage', other: '{count} Rücklagen', },
  ...
  'dash.left.confirmDay': {
    one: '{count} Buchung am Bestätigungstag ({amount}) ist bereits in diesen Salden enthalten',
    other: '{count} Buchungen am Bestätigungstag ({amount}) sind bereits in diesen Salden enthalten',
  },
  'dash.left.orders': {
  ...
  'dash.left.barAriaSetAside': 'Von {cash} sind {earmarked} zurückgelegt, {committed} gebunden und {free} frei',
  ...
  'dash.left.overdue': 'war fällig am {date}',
  ...
  'report.category.scheduled': {
    one: '{count} Buchung mit späterem Datum in dieser Periode ({amount}) ist unten aufgeführt, aber nicht in den Summen oben enthalten.',
    other: '{count} Buchungen mit späterem Datum in dieser Periode ({amount}) sind unten aufgeführt, aber nicht in den Summen oben enthalten.',
  },
  'report.health.otherCurrencies': 'Dieser Wert wurde ohne {list} ermittelt.',
  ...
  'assets.hero.totalLabel': "Gesamtwert",
  'assets.hero.items': { one: "{count} Position", other: "{count} Positionen" },
  'assets.hero.largest': "größter",
  'assets.hero.badgeOk': "jeder Wert aktuell",
  'assets.hero.badgeWarn': { one: "{count} braucht eine neue Bewertung", other: "{count} brauchen eine neue Bewertung" },
  'assets.hero.heldAbroad': "plus {list} im Ausland gehalten, nicht umgerechnet",
  'assets.hero.largestAbroad': "größter im Ausland {list}, nicht umgerechnet",

  /* ------------------------- plan view (mobile redesign) ------------------------- */
  'plan.hero.leftToPlace': "Noch zuzuweisen",
  'plan.hero.overPlaced': "Mehr zugewiesen, als dieser Plan enthält",
  'plan.hero.overSpent': "Mehr ausgegeben, als dieser Plan enthält",
  'plan.hero.ofPot': "von {pot} in diesem Plan",
  'plan.hero.allIn': "alles davon ist heute auf dem Konto",
  'plan.hero.noneIn': "nichts davon ist bisher eingegangen",
  'plan.hero.partial': "{received} ist heute auf dem Konto, {expected} wird noch erwartet",
  'plan.hero.noSources': "Noch keine Quellen — füge hinzu, was diesen Plan finanziert.",
  'plan.split.spokenFor': "Bereits verplant",
  'plan.split.notSpokenFor': "Noch nicht verplant",
  'plan.split.alreadySpent': "Bereits ausgegeben",
  'plan.split.overspent': "Überschritten",
  'plan.split.stillLeft': "Noch zum Ausgeben übrig",
  'plan.source.editAria': "Quelle {name} bearbeiten",
  'plan.source.removeAria': "Quelle {name} entfernen",
  'plan.source.inAccount': "auf dem Konto",
  'plan.source.expected': "erwartet",
  'plan.source.noDate': "Kein Datum",
  'plan.source.fieldName': "Was ist es?",
  'plan.source.fieldKind': "Art",
  'plan.source.fieldKindDesc': "Nur eine Beschriftung zur Gruppierung — sie ändert nichts an der Rechnung.",
  'plan.source.fieldAmount': "Betrag",
  'plan.source.fieldDate': "Wann kommt es an?",
  'plan.source.fieldDateDesc': "Ein Datum in der Zukunft zählt zum Plan, aber nicht zu dem, was du heute ausgeben kannst.",
  'plan.source.fieldStatus': "Status",
  'plan.source.statusReceived': "erhalten",
  'plan.source.statusExpected': "erwartet",
  'plan.source.fieldNotes': "Notizen",
  'plan.source.fieldRemove': "Diese Quelle entfernen",
  'plan.source.fieldRemoveYes': "Entfernen",
  'plan.env.expandAria': "{name} ausklappen",
  'plan.env.leftInBucket': "{amount} übrig",
  'plan.env.allSpent': "alles ausgegeben",
  'plan.env.nothingSpent': "noch nichts ausgegeben",
  'plan.env.collapseAria': "{name} einklappen",
  'plan.env.deleteAria': "Ausgabentopf {name} entfernen",
  'plan.actions.deleteAria': "Plan löschen",
