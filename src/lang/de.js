...
module.exports = {
  ...
  'dash.health.months': 'Monate notwendiger Ausgaben gedeckt',
  'dash.health.monthsMeta': 'Ziel {target} · {amount} zweckgebunden',
  ...
  'dash.health.why.intro': 'Eine Zahl von 100, aus fünf Teilen deiner Finanzen. Jeder Teil ist einen Anteil der Gesamtzahl wert, und du erhältst seine Punkte im Verhältnis dazu, wie nah du an der Bestnote bist. Ein Teil, den deine Dateien nicht beantworten können, bleibt außen vor, statt mit null bewertet zu werden.',
  'dash.health.why.bands': '{strong} und mehr ist stark · {steady}–{strongLess} ist stabil · unter {steady} braucht Aufmerksamkeit',
  ...
  'dash.health.why.fullReserves': 'Volle Punktzahl bei {target} Monaten notwendiger Ausgaben auf der Seite.',
  'dash.health.why.fullSaving': 'Volle Punktzahl bei {pct}% deines Einkommens gespart.',
  'dash.health.why.fullDebt': 'Volle Punktzahl, wenn nichts in Zinsen geht und keine Raten zu tragen sind.',
  'dash.health.why.fullSpending': 'Volle Punktzahl bei unter {fixed}% Fixkosten, Lebenshaltung unter {living}% und Ausgaben im Budget.',
  'dash.health.why.fullWealth': 'Volle Punktzahl bei einem Nettovermögen von {times}× deinem Jahreseinkommen — alles, was du besitzt, abzüglich aller Schulden.',
  'dash.health.why.fixTrim': 'Die Lebenshaltung um {amount} pro Monat zu senken brächte sie unter {pct}% des Einkommens.',
  'dash.health.why.fixBuild': 'Weitere {amount} Nettovermögen würden {times}× dein Jahreseinkommen erreichen.',
  'dash.health.why.points': '{points} von {max}',
  'dash.health.why.dragLabel': 'Kostet dich am meisten: {name}, {points} Punkte.',
  'dash.health.why.fixFund': '{amount} auf ein zweckgebundenes Konto würde {target} Monate erreichen und diese Punkte zurückholen.',
  'dash.health.why.fixMonthly': 'Weitere {amount} pro Monat ins Sparen würden {pct}% erreichen und diese Punkte zurückholen.',
  'dash.health.why.fixInterest': 'Das sind {amount} pro Monat, die dir nichts bringen — jeder abgebaute Betrag kommt als Punkte zurück.',
  'dash.health.why.allFull': 'Jeder messbare Teil hat die volle Punktzahl. Hier hält dich nichts zurück.',
