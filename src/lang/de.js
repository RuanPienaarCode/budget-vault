...
module.exports = {
  ...
  'acct.balance.impliedHint': { one: 'Deine Umsätze ergeben {amount} nach {count} Zeile seit deiner letzten Bestätigung.', other: 'Deine Umsätze ergeben {amount} nach {count} Zeilen seit deiner letzten Bestätigung.' },
  ...
  'acct.balance.updatedDrift': { one: 'Saldo von {name} gespeichert — aber {count} Zeile seit diesem Datum weicht um {amount} ab. Öffne das Konto, um sie zu sehen.', other: 'Saldo von {name} gespeichert — aber {count} Zeilen seit diesem Datum weichen um {amount} ab. Öffne das Konto, um sie zu sehen.' },
  ...
  'acct.emergency.part': 'Zweckbindung von {amount} behalten',
  ...
  'dash.health.meterTip': {
    one: '{earmarked} von den {goal}, die {count} Monat abdecken',
    other: '{earmarked} von den {goal}, die {count} Monate abdecken',
  },
  'dash.health.monthsMeta': {
    one: 'Ziel {count} Monat · {amount} zweckgebunden',
    other: 'Ziel {count} Monate · {amount} zweckgebunden',
  },
  ...
  'dash.health.over': '{name} bindet mehr, als es enthält',
  ...
  'score.win.wealth': 'Dein Besitz ist deutlich über deine Schulden hinausgewachsen. Das ist der Teil, der leise wächst.',
  ...
  'score.now.wealth': 'Jetzt: {amount} Nettovermögen · {times}× ein Jahreseinkommen',
  ...
  'score.flow.chip.allocatedOfIncome': 'Anteil des Einkommens verplant',
  ...
  'score.flow.chip.lefts': 'Zwei verschiedene "Reste"',
