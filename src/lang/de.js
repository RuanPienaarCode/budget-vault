...
module.exports = {
  ...
  'acct.balance.impliedHint': 'Deine Umsätze ergeben {amount} nach {count} Zeile(n) seit deiner letzten Bestätigung.',
  ...
  'acct.balance.updatedDrift': 'Saldo von {name} gespeichert — aber {count} Zeile(n) seit diesem Datum weichen um {amount} ab. Öffne das Konto, um sie zu sehen.',
