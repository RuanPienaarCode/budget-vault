...
module.exports = {
  ...
  'dash.health.why.title': 'So entsteht dieser Score',
  'dash.health.why.intro': 'Dein Wert von 100, aus fünf Teilen deines Geldes. Was deine Dateien nicht zeigen können, bleibt einfach außen vor — es zählt nie gegen dich.',
  ...
  'dash.health.why.fullReserves': 'Geld, das für Notfälle zurückgelegt ist. Volle Punktzahl, wenn es {target} Monate unvermeidbarer Kosten (Miete, Essen, Fahrten) decken könnte, falls dein Einkommen ausbleibt.',
  'dash.health.why.fullSaving': 'Wie viel von deinem Einkommen du zurücklegst. Volle Punktzahl, wenn du jeden Monat {pct}% deines Verdienstes sparst.',
  'dash.health.why.fullDebt': 'Was dich deine Schulden kosten. Volle Punktzahl, wenn du keine Zinsen zahlst und keine Kredit- oder Kartenraten hast.',
  'dash.health.why.fullSpending': 'Wie deine Ausgaben zu deinem Einkommen stehen. Volle Punktzahl, wenn Fixkosten (Miete, Versicherung, Abos) unter {fixed}% liegen, der gesamte Alltag unter {living}% bleibt und du im Budget bleibst.',
  'dash.health.why.fullWealth': 'Alles, was du besitzt (Ersparnisse, Anlagen, Immobilien), minus alles, was du schuldest (Kredite, Karten). Volle Punktzahl, wenn das {times} Jahreseinkommen ergibt.',
  ...
  'dash.health.why.dragLabel': 'Größte Lücke: {name}, {points} Punkte.',
  ...
  'dash.health.why.allFull': 'Alles Messbare hat die volle Punktzahl. Nichts hält dich zurück.',
  'dash.health.why.aria': 'Finanz-Score — wie er berechnet wird und was ihn verbessern würde',
  ...
  'score.how.title': 'Wie der Score aufgebaut ist',
  'score.how.sub': 'Fünf Teile, jeder ein Anteil von 100',
  'score.how.worth': 'wert {points}',
