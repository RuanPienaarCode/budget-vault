...
module.exports = {
  ...
  'dash.health.why.intro': 'Ein Wert von 100, aus fünf Teilen deines Geldes. Jeder Teil ist einen Anteil wert. Was deine Dateien nicht beantworten, bleibt außen vor und wird nicht mit null gewertet.',
  ...
  'dash.health.why.fullReserves': 'Ziel: {target} Monate notwendiger Ausgaben gespart.',
  'dash.health.why.fullSaving': 'Ziel: {pct}% deines Einkommens sparen.',
  'dash.health.why.fullDebt': 'Ziel: keine Zinsen und keine Raten.',
  'dash.health.why.fullSpending': 'Ziel: Fixkosten unter {fixed}% des Einkommens, Lebenshaltung unter {living}%, Ausgaben im Budget.',
  'dash.health.why.fullWealth': 'Ziel: Besitz minus Schulden erreicht {times}× ein Jahreseinkommen.',
  'dash.health.why.fixTrim': 'Senke die Lebenshaltung um {amount} pro Monat, um unter {pct}% zu kommen.',
  'dash.health.why.fixBuild': 'Lass deinen Besitz um {amount} wachsen, um {times}× ein Jahreseinkommen zu erreichen.',
  'dash.health.why.points': '{points} von {max}',
  'dash.health.why.dragLabel': 'Größte Lücke: {name}, {points} Punkte.',
  'dash.health.why.fixFund': 'Lege {amount} mehr auf ein zweckgebundenes Konto, um {target} Monate zu erreichen.',
  'dash.health.why.fixMonthly': 'Spare {amount} mehr pro Monat, um {pct}% zu erreichen.',
  'dash.health.why.fixInterest': 'Das sind {amount} pro Monat für nichts — wer sie abbaut, holt die Punkte zurück.',
