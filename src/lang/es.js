...
module.exports = {
  ...
  'wiz.rates.on.desc': 'El complemento pide a un servicio público de tipos de cambio los tipos del día y los guarda como una nota en su bóveda — una vez al día para empezar, algo que puede cambiar a semanal o mensual en Ajustes. Solo envía un código de moneda — nunca sus saldos, sus cuentas ni nada más. Cada importe convertido se muestra con la fecha de su tipo.',
  ...
  'wiz.ccy.euro': '€ — Euro',
  'wiz.ccy.pound': '£ — Libra',
  'wiz.ccy.rupee': '₹ — Rupia india',
  'wiz.ccy.rupiah': 'Rp — Rupia indonesia',
  'wiz.ccy.real': 'R$ — Real brasileño',
  'wiz.ccy.other': 'Otro…',
  ...
  'bx.range.12': '1 año',
  'bx.range.all': 'Todo',
  'bx.includeCurrent': 'Incluir el periodo actual',
  'bx.includeCurrent.desc': 'Todavía está en curso, así que sus cifras corresponden solo a una parte de un periodo. Desactívalo para exportar solo periodos terminados.',
  'bx.content': 'Qué exportar',
  'bx.content.full': 'Presupuesto completo',
  'bx.content.summary': 'Resumen por categoría',
  'bx.content.full.desc': 'Un resumen mes a mes y luego el presupuesto de cada periodo: qué se planeó, qué se gastó y qué quedó, por categoría.',
  'bx.content.summary.desc': 'Una tabla: lo que sumó cada categoría en cada periodo, con un total, un promedio y el importe presupuestado.',
  'bx.cats': 'Categorías',
  'bx.cats.all': 'Todas las categorías',
  'bx.cats.pick': 'Elegir…',
  'bx.cats.selectAll': 'Seleccionar todas',
  'bx.cats.selectNone': 'No seleccionar ninguna',
  'bx.cats.count': '{count} de {total} seleccionadas',
  'bx.includeTx': 'Incluir las transacciones',
  'bx.includeTx.desc': 'Añade las transacciones individuales detrás de las cifras, para los mismos periodos y categorías.',
  'bx.format': 'Tipo de archivo',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — para leer, imprimir o enviar.',
  'bx.format.xlsx.desc': 'Excel — un libro con una hoja por tabla, importes como números reales.',
  'bx.format.csv.desc': 'CSV — un archivo sencillo por tabla, para otro programa.',
  'bx.folder': 'Guardar en la carpeta',
  'bx.folder.desc': 'Una carpeta en esta bóveda. Exportar la misma selección de nuevo reemplaza los archivos anteriores.',
  'bx.cancel': 'Cancelar',
  'bx.go': 'Exportar',
  'bx.preview': {
    one: '{count} periodo · {range} · {cats} categorías',
    other: '{count} periodos · {range} · {cats} categorías',
  },
  'bx.replaces': {
    one: 'Esto reemplaza un archivo que ya existe: {files}',
    other: 'Esto reemplaza {count} archivos que ya existen: {files}',
  },
  'bx.problem.configDir': 'Eso está dentro de {folder}, donde Obsidian guarda su propia configuración — los archivos allí no se muestran en tu bóveda. Elige otra carpeta.',
  'bx.problem.noPeriods': 'Todavía no hay ningún periodo terminado con datos — activa "Incluir el periodo actual".',
  'bx.problem.noCats': 'Elige al menos una categoría.',
  'bx.problem.noRows': 'Nada que exportar — no hay presupuesto ni gasto en las categorías elegidas para este periodo.',
  'bx.dirty': 'Guarda tus cambios primero — una exportación con ediciones sin guardar no coincidiría con la bóveda',
  'bx.failed': 'No se pudo escribir la exportación ({error}) — revisa el nombre de la carpeta',
  'bx.failedPartial': {
    one: 'La exportación se detuvo después de {count} archivo ({error})',
    other: 'La exportación se detuvo después de {count} archivos ({error})',
  },
  'bx.done': {
    one: 'Exportado {count} archivo a {path}/',
    other: 'Exportados {count} archivos a {path}/',
  },
  'bx.done.title': 'Presupuesto exportado',
  'bx.done.open': 'Abrir',
  'bx.done.reveal': 'Mostrar en el explorador de archivos',
  'bx.done.close': 'Listo',
  'bx.done.hint': 'Los archivos están en tu bóveda. Para enviar uno, ábrelo o búscalo en el explorador de archivos y usa la opción de compartir o guardar de tu dispositivo.',
  'bx.done.raster': 'Parte del texto de esta exportación usa caracteres que la fuente PDF integrada no puede dibujar, así que las páginas del PDF se guardaron como imágenes. Se ve igual, pero su texto no se puede seleccionar ni buscar. Los archivos de Excel y CSV no se ven afectados.',
  'bx.doc.title': 'Presupuesto',
  'bx.doc.titleSummary': 'Resumen del presupuesto',
  'bx.doc.category': 'Categoría',
  'bx.doc.type': 'Tipo',
  'bx.doc.total': 'Total',
  'bx.doc.average': 'Promedio',
  'bx.doc.budgeted': 'Presupuestado',
  'bx.doc.period': 'Periodo',
  'bx.doc.from': 'Desde',
  'bx.doc.to': 'Hasta',
  'bx.doc.budget': 'Presupuesto',
  'bx.doc.actual': 'Real',
  'bx.doc.remaining': 'Restante',
  'bx.doc.used': 'Usado',
  'bx.doc.notes': 'Notas',
  'bx.doc.date': 'Fecha',
  'bx.doc.description': 'Descripción',
  'bx.doc.account': 'Cuenta',
  'bx.doc.currency': 'Moneda',
  'bx.doc.amount': 'Importe',
  'bx.doc.flag': 'Marca',
  'bx.doc.excluded': 'excluida',
  'bx.doc.splitParent': 'origen dividido',
  'bx.doc.splitPart': 'parte dividida',
  'bx.doc.subtotal': 'Total {type}',
  'bx.doc.summaryHeading': 'Resumen por categoría',
  'bx.doc.transactionsHeading': 'Transacciones',
  'bx.doc.generated': 'Generado',
  'bx.doc.range': 'Periodo',
  'bx.doc.categories': 'Categorías',
  'bx.doc.allCategories': 'Todas las categorías',
  'bx.doc.periodLine': 'Ingresos {income} · Gastos {spend}',
  'bx.doc.periodUncat': ' · Sin categorizar {uncat}',
  'bx.doc.noteFilter': 'Solo se incluyen estas categorías: {list}. Los totales cubren las categorías listadas, no todo el presupuesto.',
  'bx.doc.noteForeign': 'Las cuentas en {list} no se incluyen en ninguna cifra aquí — no hay tipo de cambio en este archivo para combinarlas.',
  ...
  'acct.balance.impliedHint': { one: 'Tus transacciones suman {amount} — {count} de ellas desde tu última confirmación.', other: 'Tus transacciones suman {amount} — {count} de ellas desde tu última confirmación.' },
  ...
  'acct.balance.updatedDrift': { one: 'Saldo de {name} guardado, pero {count} transacción desde entonces suma {amount} más o menos que la cifra guardada. Abre la cuenta para verla.', other: 'Saldo de {name} guardado, pero {count} transacciones desde entonces suman {amount} más o menos que la cifra guardada. Abre la cuenta para verlas.' },
  'acct.balance.unreadable': 'No se pudo leer «{raw}» — toca para corregirlo',
  'acct.reconciled': 'Saldo de {name} fijado en {amount} — coincide con tus transacciones',
  'acct.toast.updated': '{name} actualizada',
  'acct.deck.ignore': 'Ignorar',
  'acct.deck.ariaIgnore': 'Ignorar este aviso en {name}',
  'acct.toast.ignored': '{name}: este aviso ahora se ignora. Deshazlo en Editar.',
  ...
  'acct.mute.drift': 'El saldo no coincide con los movimientos',
  ...
  'acct.counts.no': 'No — cuenta de ahorro o inversión',
  ...
  'acct.emergency.part': 'Mantener {amount} apartado',
  'acct.field.limit': 'Límite de crédito',
  'acct.field.limitDesc': 'Muestra cuánto del límite se ha usado, en las tarjetas de crédito.',
  ...
  'report.debt.otherCurrencies': ' Más {list} adeudados en otras monedas, sin convertir.',
  ...
  'settings.exchangeRates.on': 'Activado — obtener tipos de cambio',
  'settings.exchangeRates.desc': 'Desactivado por defecto, y lo único de este complemento que hace una petición de red. Activado, pide a un servicio público de tipos de cambio los tipos del día con la frecuencia que elija abajo, los guarda como una nota legible en su carpeta de presupuesto y suma a sus totales las cuentas en otras monedas. Solo envía un código de moneda — nunca sus saldos ni los nombres de sus cuentas. Cada importe convertido se imprime con la fecha de su tipo, y un tipo de más de una semana lo indica.',
  'settings.rateRefresh.name': 'Con qué frecuencia obtener los tipos',
  'settings.rateRefresh.desc': 'Con qué frecuencia el complemento puede pedir tipos nuevos, cuando los tipos de cambio están activados arriba. A diario es lo que siempre ha prometido. Semanal o mensual significa menos peticiones — cada importe convertido sigue mostrando la fecha de su tipo, así que un tipo que eligió obtener pocas veces sigue diciendo qué antigüedad tiene.',
  'settings.rateRefresh.daily': 'A diario',
  ...
  'acct.deck.show': "Mostrarlas",
  'acct.deck.groupReason.drift': "El saldo no coincide con las transacciones",
  'acct.deck.groupReason.stale': "El saldo no se ha confirmado en un tiempo",
  'acct.deck.groupReason.unreadable': "Algunas transacciones tienen una fecha que nada puede leer",
  'acct.deck.groupReason.nodate': "El saldo no tiene una fecha de confirmación legible",
  'acct.deck.groupReason.notx': "Hay una carpeta vinculada, pero aún no se ha importado nada",
  'acct.deck.groupReason.nofolder': "No se importa nada en estas cuentas, así que nada puede comprobar la cifra",
  ...
  'acct.table.otherCurrencies': 'más {list}',
  ...
  'acct.state.drift': 'no coincide',
  'acct.state.unreadable': 'fecha ilegible',
  ...
  'acct.drawer.recon.stale': 'Confirmada por última vez el {date}. Confírmala y la comprobación empieza de nuevo hoy.',
  'acct.drawer.recon.nodate': 'Aún no hay fecha confirmada — indícala y esta cifra podrá comprobarse contra tus transacciones.',
  ...
  'acct.drawer.recon.unreadable': 'Esta cifra todavía no se puede comprobar contra tus transacciones.',
  ...
  'dash.hero.assumedIncluded': 'incluye {amount} ya gastado',
  'dash.hero.nettedOff': '{amount} en reembolsos descontados',
  ...
  'dash.stat.allocated': '{pct}% de los ingresos presupuestado',
  'dash.stat.allocatedOf': '{pct}% de los {amount} de ingresos que este presupuesto prevé',
  'dash.stat.setAside': '{amount} reservado',
  'dash.stat.setAsideMoved': '{amount} reservado, {moved} movido hasta ahora',
  ...
  'dash.fundedFromSavings': {
    ...
    other: '{amount} más salió de tus fondos ({count} movimientos), que este presupuesto no cuenta',
  },
  'dash.stat.used': '{pct}% usado',
  'dash.stat.review': 'revisar en Transacciones',
  'dash.stat.notIncome': '{amount} entró sin categoría — no se cuenta aquí',
  ...
  'dash.stale.driftUp': ' Los movimientos desde entonces suman {amount} más.',
  'dash.stale.driftDown': ' Los movimientos desde entonces suman {amount} menos.',
  ...
  'dash.health.meterTip': {
    one: '{earmarked} apartado de los {goal} que cubren {count} mes',
    other: '{earmarked} apartado de los {goal} que cubren {count} meses',
  },
  'dash.health.monthsMeta': {
    one: 'Meta {count} mes · {amount} apartado',
    other: 'Meta {count} meses · {amount} apartado',
  },
  ...
  'dash.health.over': '{name} está marcada para apartar más de lo que realmente tiene',
  ...
  'score.win.wealth': 'Lo que posees ha crecido muy por encima de lo que debes. Esa es la parte que crece sola, en silencio.',
  ...
  'score.now.wealth': 'Ahora: {amount} de patrimonio neto · equivale a {times} años de ingresos',
  ...
  'score.flow.overspent.sub': "Gastaste {amount} más de lo que entró",
  ...
  'score.flow.subA.overBudget': "{amount} por encima del presupuesto · {neverBudgeted} nunca presupuestado",
  ...
  'score.flow.chip.ofWhichInterest': 'intereses dentro de eso',
  ...
  'score.flow.chip.allocatedOfIncome': 'Parte de los ingresos presupuestada',
  'score.flow.chip.spent': 'Gastado',
  'score.flow.chip.budgetUsed': 'Presupuesto usado este periodo',
  'score.flow.chip.budgetUsedNote': 'Solo este periodo — la puntuación de arriba usa una media de seis periodos.',
  'score.flow.chip.lefts': 'Dinero sobrante — dos tipos',
  ...
  'dash.left.earmarkedFrom': { one: '{count} fondo', other: '{count} fondos', },
  ...
  'dash.left.confirmDay': {
    one: '{count} movimiento en la fecha de confirmación ({amount}) ya está incluido en estos saldos',
    other: '{count} movimientos en la fecha de confirmación ({amount}) ya están incluidos en estos saldos',
  },
  'dash.left.orders': {
  ...
  'dash.left.instalments': {
    one: '{count} pago de deuda',
    other: '{count} pagos de deuda',
  },
  'dash.left.cards': {
  ...
  'dash.left.barAriaSetAside': 'De {cash}, {earmarked} está reservado, {committed} comprometido y {free} libre',
  ...
  'dash.left.overdue': 'vencía el {date}',
  ...
  'nav.report': 'Informe',
  'shell.tx.report': 'Informe',
  'report.pageSub': 'Una nota en Markdown · léela en Obsidian, compártela o pégala en un chat de IA',
  'report.options.title': 'Opciones del informe',
  'report.field.period': 'Periodo',
  'report.field.detail': 'Detalle',
  'report.field.format': 'Formato',
  'report.field.folder': 'Carpeta',
  'report.field.folderDesc': 'Dónde se escribe la nota — se recuerda para la próxima vez.',
  'report.field.folderManaged': 'Esto está dentro de {folder}, una carpeta que gestiona esta aplicación — un informe guardado aquí se leería como datos (por ejemplo, una nueva categoría) la próxima vez que se cargue la bóveda. Elige otra carpeta.',
  'report.period.current': 'Mes actual',
  'report.period.current.desc': 'Solo este periodo de presupuesto.',
  'report.period.3m': 'Últimos 3 meses',
  'report.period.3m.desc': 'Los últimos 3 meses, o menos si el vault no llega tan atrás.',
  ...
  'report.format.md.desc': 'Léela en Obsidian, compártela, o ábrela como PDF desde la app de escritorio.',
  'report.format.json': 'JSON',
  'report.format.json.desc': 'Números en bruto y un código de moneda, para una herramienta que prefiera analizar antes que leer.',
  'report.format.pillsAria': 'Formato de archivo del informe',
  'report.to': 'a',
  'report.preview': 'Se creará: {path}',
  'report.exists': 'Ya existe para esta selección ({formats}) — volver a crearlo lo sobrescribe.',
  'report.create': 'Crear informe',
  'report.recreate': 'Volver a crear informe (sobrescribir)',
  'report.contains.title': 'Este informe incluirá:',
  'report.contains.incomeSpend': 'Ingresos frente a gastos',
  'report.contains.category': 'Gastos por categoría',
  'report.contains.budget': 'Presupuesto frente a real',
  'report.contains.savings': 'Crecimiento de ahorros e inversiones (a día de hoy)',
  'report.contains.debt': 'Posición de deuda (a día de hoy)',
  'report.contains.netWorth': 'Patrimonio neto (a día de hoy)',
  'report.contains.health': 'Puntuación de salud financiera (a día de hoy), si hay historial suficiente',
  'report.contains.transactions': 'Cada transacción del periodo, listada',
  'report.created': 'Informe creado',
  'report.createdPartial': 'Informe creado parcialmente — un archivo falló ({error})',
  'report.createFailed': 'No se pudo crear el informe ({error})',
  'report.result.title': 'Informe listo',
  'report.result.generated': 'Generado {date}',
  'report.result.found': 'Ya está en el disco, de un informe anterior',
  'report.open': 'Abrir informe',
  'report.openFailed': 'No se pudo abrir ese informe — puede que el archivo se haya movido',
  'report.copy': 'Copiar para IA',
  'report.copyJson': 'Copiar JSON',
  'report.copied': 'Copiado al portapapeles',
  'report.copyFailed': 'No se pudo copiar el informe ({error})',
  'report.shareHint': 'Para enviarlo de otra forma, abre la nota y usa el propio menú de compartir de Obsidian.',
  ...
  'report.col.net': 'Neto',
  'report.col.budgetIncome': 'Ingresos presupuestados',
  'report.col.budgetSpend': 'Gastos presupuestados',
  'report.section.category': 'Gastos por Categoría',
  ...
  'report.category.scheduled': {
    one: '{count} movimiento con fecha posterior en este periodo ({amount}) aparece abajo pero no se cuenta en los totales de arriba.',
    other: '{count} movimientos con fecha posterior en este periodo ({amount}) aparecen abajo pero no se cuentan en los totales de arriba.',
  },
  'report.health.otherCurrencies': 'Esta puntuación se calculó sin {list}.',
  ...
  'report.col.category': 'Categoría',
  'report.col.amount': 'Importe',
  'report.col.percent': '%',
  'report.section.budgetActual': 'Presupuesto frente a Real',
  'report.budget.empty': 'No se registró presupuesto ni gasto en este periodo.',
  'report.col.type': 'Tipo',
  'report.col.budget': 'Presupuesto',
  'report.col.actual': 'Real',
  'report.col.remaining': 'Restante',
  'report.section.savings': 'Crecimiento de Ahorros e Inversiones',
  'report.asOf': '_A día de hoy — no limitado al periodo anterior; ver la nota bajo este título en la app._',
  'report.savings.none': 'No hay cuentas de ahorro o inversión registradas.',
  'report.savings.unmeasured': 'Ninguna cuenta de ahorro o inversión tiene un importe inicial o fecha de inicio configurados, así que el crecimiento aún no se puede medir.',
  ...
  'report.debt.free': {
    one: 'Sin deudas — {count} deuda registrada, saldada.',
    other: 'Sin deudas — {count} deudas registradas, todas saldadas.',
  },
  ...
  'report.col.interest': 'Interés mensual',
  'report.section.netWorth': 'Patrimonio Neto',
  'report.col.netWorth': 'Patrimonio neto',
  'report.col.owned': 'En propiedad',
  'report.col.owed': 'Adeudado',
  'report.section.health': 'Salud Financiera',
  'report.health.score': 'Puntuación',
  ...
  'report.transactions.count': {
    ...
    other: '{count} transacciones en este periodo.',
  },

  /* --- second pass: topbar report button + up-front copy + reveal-in-folder --- */
  'topbar.report': 'Generar informe',
  'topbar.reportTitle': 'Generar un informe financiero',
  'report.copyNow': 'Copiar informe',
  'report.reveal': 'Abrir carpeta del informe',
  'report.revealNone': 'Nada que mostrar todavía — crea primero un informe.',
  'report.revealUnavailable': 'El explorador de archivos está desactivado en Obsidian, así que este informe no se puede mostrar allí.',
  'report.revealFailed': 'No se pudo mostrar ese informe ({error})',

  /* ------------------------- assets page hero (redesign) ------------------------- */
  'assets.hero.totalLabel': "Valor total",
  'assets.hero.items': { one: "{count} elemento", other: "{count} elementos" },
  'assets.hero.largest': "mayor",
  'assets.hero.badgeOk': "todos los valores al día",
  'assets.hero.badgeWarn': { one: "{count} necesita una nueva valoración", other: "{count} necesitan una nueva valoración" },
  'assets.hero.heldAbroad': "más {list} en el extranjero, sin convertir",
  'assets.hero.largestAbroad': "mayor en el extranjero {list}, sin convertir",

  /* ------------------------- plan view (mobile redesign) ------------------------- */
  'plan.hero.leftToPlace': "Por asignar",
  'plan.hero.overPlaced': "Se asignó más de lo que contiene este plan",
  'plan.hero.overSpent': "Se gastó más de lo que contiene este plan",
  'plan.hero.ofPot': "de {pot} en este plan",
  'plan.hero.allIn': "todo está hoy en la cuenta",
  'plan.hero.noneIn': "nada de eso ha llegado todavía",
  'plan.hero.partial': "{received} está hoy en la cuenta, {expected} aún se espera",
  'plan.hero.noSources': "Aún no hay fuentes — añade lo que financia este plan.",
  'plan.split.spokenFor': "Ya asignado",
  'plan.split.notSpokenFor': "Sin asignar",
  'plan.split.alreadySpent': "Ya gastado",
  'plan.split.overspent': "Sobregasto",
  'plan.split.stillLeft': "Aún queda por gastar",
  'plan.source.editAria': "Editar fuente {name}",
  'plan.source.removeAria': "Quitar fuente {name}",
  'plan.source.inAccount': "en la cuenta",
  'plan.source.expected': "esperado",
  'plan.source.noDate': "Sin fecha",
  'plan.source.fieldName': "¿Qué es?",
  'plan.source.fieldKind': "Tipo",
  'plan.source.fieldKindDesc': "Solo una etiqueta para agrupar — no cambia nada del cálculo.",
  'plan.source.fieldAmount': "Importe",
  'plan.source.fieldDate': "¿Cuándo llega?",
  'plan.source.fieldDateDesc': "Una fecha futura cuenta para el plan, pero no para lo que puedes gastar hoy.",
  'plan.source.fieldStatus': "Estado",
  'plan.source.statusReceived': "recibido",
  'plan.source.statusExpected': "esperado",
  'plan.source.fieldNotes': "Notas",
  'plan.source.fieldRemove': "Quitar esta fuente",
  'plan.source.fieldRemoveYes': "Quitarla",
  'plan.env.expandAria': "Expandir {name}",
  'plan.env.leftInBucket': "quedan {amount}",
  'plan.env.allSpent': "todo gastado",
  'plan.env.nothingSpent': "aún no se ha gastado nada",
  'plan.env.collapseAria': "Contraer {name}",
  'plan.env.deleteAria': "Quitar la bolsa de gasto {name}",
  'plan.actions.deleteAria': "Eliminar plan",
