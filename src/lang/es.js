...
module.exports = {
  ...
  'dash.health.why.title': 'Cómo funciona esta puntuación',
  'dash.health.why.intro': 'Tu puntuación sobre 100, formada por cinco partes de tu dinero. Lo que tus archivos no pueden mostrar simplemente se deja fuera: nunca cuenta en tu contra.',
  ...
  'dash.health.why.fullReserves': 'Dinero reservado para emergencias. Puntuación máxima cuando cubre {target} meses de gastos imprescindibles (alquiler, comida, transporte) si se corta tu ingreso.',
  'dash.health.why.fullSaving': 'Qué parte de tus ingresos guardas. Puntuación máxima cuando ahorras el {pct}% de lo que ganas cada mes.',
  'dash.health.why.fullDebt': 'Lo que te cuesta tu deuda. Puntuación máxima cuando no pagas intereses ni cuotas de préstamos o tarjetas.',
  'dash.health.why.fullSpending': 'Cómo se compara tu gasto con tus ingresos. Puntuación máxima cuando los gastos fijos (alquiler, seguros, suscripciones) ocupan menos del {fixed}%, todo el gasto del día a día menos del {living}%, y te mantienes dentro del presupuesto.',
  'dash.health.why.fullWealth': 'Todo lo que posees (ahorros, inversiones, propiedades) menos todo lo que debes (préstamos, tarjetas). Puntuación máxima cuando eso suma {times} años de tus ingresos.',
  ...
  'dash.health.why.dragLabel': 'Mayor diferencia: {name}, {points} puntos.',
  ...
  'dash.health.why.allFull': 'Todo lo medible está al máximo. Nada te está frenando.',
  'dash.health.why.aria': 'Puntuación financiera — cómo se calcula y qué la mejoraría',
  ...
  'score.how.title': 'Cómo se construye la puntuación',
  'score.how.sub': 'Cinco partes, cada una una porción de 100',
  'score.how.worth': 'vale {points}',
  ...
  'score.rail.aria': 'Puntuación de {score} sobre 100, construida a partir de cinco partes: {parts}.',
