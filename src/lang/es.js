...
module.exports = {
  ...
  'acct.balance.impliedHint': 'Tus transacciones implican {amount} tras {count} fila(s) desde tu última confirmación.',
  ...
  'acct.balance.updatedDrift': 'Saldo de {name} guardado, pero {count} fila(s) desde esa fecha difieren en {amount}. Abre la cuenta para verlas.',
