...
module.exports = {
  ...
  'dash.health.why.intro': 'Una puntuación sobre 100, a partir de cinco partes de tu dinero. Cada parte vale una porción del total. Lo que tus archivos no pueden responder se deja fuera, no se puntúa con cero.',
  ...
  'dash.health.why.fullReserves': 'Meta: {target} meses de gastos esenciales ahorrados.',
  'dash.health.why.fullSaving': 'Meta: ahorrar el {pct}% de lo que ganas.',
  'dash.health.why.fullDebt': 'Meta: sin intereses y sin cuotas.',
  'dash.health.why.fullSpending': 'Meta: gastos fijos bajo el {fixed}% de los ingresos, gastos de vida bajo el {living}% y gastar dentro del presupuesto.',
  'dash.health.why.fullWealth': 'Meta: lo que posees, menos lo que debes, llega a {times}× un año de ingresos.',
  'dash.health.why.fixTrim': 'Reduce los gastos de vida en {amount} al mes para bajar del {pct}%.',
  'dash.health.why.fixBuild': 'Haz crecer lo que posees en {amount} para llegar a {times}× un año de ingresos.',
  'dash.health.why.points': '{points} de {max}',
  'dash.health.why.dragLabel': 'Mayor diferencia: {name}, {points} puntos.',
  'dash.health.why.fixFund': 'Pon {amount} más en una cuenta reservada para llegar a {target} meses.',
  'dash.health.why.fixMonthly': 'Ahorra {amount} más al mes para llegar al {pct}%.',
  'dash.health.why.fixInterest': 'Son {amount} al mes que no te dan nada: liquidarlo recupera los puntos.',
