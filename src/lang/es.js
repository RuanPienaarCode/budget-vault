...
module.exports = {
  ...
  'dash.health.months': 'meses de gastos esenciales cubiertos',
  'dash.health.monthsMeta': 'meta {target} · {amount} reservado',
  ...
  'dash.health.why.intro': 'Un número sobre 100, a partir de cinco partes de tus finanzas. Cada parte vale una porción del total, y ganas sus puntos en proporción a lo cerca que estés de la puntuación máxima. Una parte que tus archivos no pueden responder se deja fuera en lugar de puntuarse con cero.',
  'dash.health.why.bands': '{strong} o más es sólida · {steady}–{strongLess} es estable · por debajo de {steady} necesita atención',
  ...
  'dash.health.why.fullReserves': 'Puntuación máxima con {target} meses de gastos esenciales apartados.',
  'dash.health.why.fullSaving': 'Puntuación máxima al ahorrar el {pct}% de tus ingresos.',
  'dash.health.why.fullDebt': 'Puntuación máxima sin nada en intereses y sin cuotas que arrastrar.',
  'dash.health.why.fullSpending': 'Puntuación máxima con menos del {fixed}% de ingresos en costes fijos, gastos de vida bajo el {living}% y gasto dentro de tu presupuesto.',
  'dash.health.why.fullWealth': 'Puntuación máxima con un patrimonio neto de {times}× tus ingresos anuales — todo lo que posees, menos todo lo que debes.',
  'dash.health.why.fixTrim': 'Reducir los gastos de vida en {amount} al mes los dejaría bajo el {pct}% de los ingresos.',
  'dash.health.why.fixBuild': 'Otros {amount} de patrimonio neto alcanzarían {times}× tus ingresos anuales.',
  'dash.health.why.points': '{points} de {max}',
  'dash.health.why.dragLabel': 'Lo que más te cuesta: {name}, {points} puntos.',
  'dash.health.why.fixFund': 'Añadir {amount} a una cuenta reservada alcanzaría {target} meses y recuperaría esos puntos.',
  'dash.health.why.fixMonthly': 'Destinar {amount} más al mes al ahorro alcanzaría el {pct}% y recuperaría esos puntos.',
  'dash.health.why.fixInterest': 'Son {amount} al mes que no te compran nada — cada parte que liquides vuelve como puntos.',
  'dash.health.why.allFull': 'Todas las partes que se pueden medir están en la puntuación máxima. Nada aquí te está frenando.',
