...
module.exports = {
  ...
  'wiz.rates.on.desc': '插件会向公开汇率服务请求当日汇率，并将其作为一则笔记保存在你的仓库中——起初为每天一次，你可以在设置中改为每周或每月。它只发送货币代码——绝不发送你的余额、账户或其他任何信息。每个换算后的金额都会显示其汇率的日期。',
  ...
  'wiz.ccy.pound': '£ — 英镑',
  'wiz.ccy.rupee': '₹ — 印度卢比',
  'wiz.ccy.rupiah': 'Rp — 印尼盾',
  'wiz.ccy.real': 'R$ — 巴西雷亚尔',
  'wiz.ccy.other': '其他…',
  ...
  'bx.mode.months': '按月回溯',
  'bx.mode.dates': '日期范围',
  'bx.preset.taxThis': '本纳税年度',
  'bx.preset.taxLast': '上一纳税年度',
  'bx.preset.calThis': '今年',
  'bx.preset.calLast': '去年',
  'bx.preset.custom': '自定义',
  'bx.dates.from': '从',
  'bx.dates.to': '到',
  'bx.dates.desc': '支出和交易明细使用的正是这些日期。预算表会显示在此范围内结束的每一个完整预算周期——预算不会按日期拆分。',
  'bx.previewDates': {
    other: '{range} · {count} 个预算周期 · {cats} 个分类',
  },
  'bx.problem.badDates': '请选择开始日期和结束日期，开始日期须早于结束日期。',
  'bx.range': '往前追溯多久',
  'bx.range.1': '1 个月',
  'bx.range.2': '2 个月',
  'bx.range.3': '3 个月',
  ...
  'bx.range.12': '1 年',
  'bx.range.all': '全部',
  'bx.includeCurrent': '包含当前周期',
  'bx.includeCurrent.desc': '该周期仍在进行中，因此其数字只反映部分周期。关闭此项以仅导出已结束的周期。',
  'bx.content': '要导出的内容',
  'bx.content.full': '完整预算',
  'bx.content.summary': '分类汇总',
  'bx.content.full.desc': '按月汇总，然后是每个周期的预算：每个分类计划了多少、花费了多少、剩下多少。',
  'bx.content.summary.desc': '一张表：每个分类在每个周期的总额，包括合计、平均值和预算金额。',
  'bx.cats': '分类',
  'bx.cats.all': '所有分类',
  'bx.cats.pick': '选择…',
  'bx.cats.selectAll': '全选',
  'bx.cats.selectNone': '全不选',
  'bx.cats.count': '已选 {count} / {total}',
  'bx.includeTx': '包含交易明细',
  'bx.includeTx.desc': '在数字背后添加各笔交易，覆盖相同的周期和分类。',
  'bx.format': '文件类型',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — 用于阅读、打印或发送。',
  'bx.format.xlsx.desc': 'Excel — 一个工作簿，每张表一个工作表，金额为真实数字。',
  'bx.format.csv.desc': 'CSV — 每张表一个纯文本文件，供其他程序使用。',
  'bx.folder': '保存到文件夹',
  'bx.folder.desc': '仓库中的一个文件夹。再次导出相同的选择会替换之前的文件。',
  'bx.cancel': '取消',
  'bx.go': '导出',
  'bx.preview': {
  ...
  'bx.dirty': '请先保存更改 — 导出未保存的编辑将与仓库内容不一致',
  'bx.failed': '无法写入导出文件（{error}） — 请检查文件夹名称',
  'bx.failedPartial': {
    other: '导出在 {count} 个文件后停止（{error}）',
  },
  'bx.done': {
    other: '已把 {count} 个文件导出到 {path}/',
  },
  'bx.done.title': '预算已导出',
  'bx.done.open': '打开',
  'bx.done.reveal': '在文件浏览器中显示',
  'bx.done.close': '完成',
  'bx.done.hint': '文件已保存在你的仓库中。要发送某个文件，请打开它，或在文件浏览器中找到它，然后使用设备的分享或保存功能。',
  'bx.done.raster': '此次导出的部分文本使用了内置 PDF 字体无法绘制的字符，因此 PDF 页面被保存为图片。看起来一样，但文本无法被选中或搜索。Excel 和 CSV 文件不受影响。',
  'bx.doc.title': '预算',
  'bx.doc.titleSummary': '预算汇总',
  'bx.doc.category': '分类',
  'bx.doc.type': '类型',
  'bx.doc.total': '合计',
  'bx.doc.average': '平均值',
  'bx.doc.budgeted': '预算金额',
  'bx.doc.period': '周期',
  'bx.doc.from': '从',
  'bx.doc.to': '到',
  'bx.doc.budget': '预算',
  ...
  'bx.doc.flag': '标记',
  'bx.doc.excluded': '已排除',
  'bx.doc.splitParent': '拆分源',
  'bx.doc.splitPart': '拆分部分',
  'bx.doc.subtotal': '{type}合计',
  'bx.doc.summaryHeading': '按分类汇总',
  'bx.doc.transactionsHeading': '交易',
  'bx.doc.generated': '生成时间',
  'bx.doc.range': '周期',
  'bx.doc.categories': '分类',
  'bx.doc.allCategories': '所有分类',
  'bx.doc.periodLine': '收入 {income} · 支出 {spend}',
  'bx.doc.periodUncat': ' · 未分类 {uncat}',
  'bx.doc.noteFilter': '仅包含以下分类：{list}。合计只覆盖所列分类，不是整个预算。',
  'bx.doc.noteForeign': '{list} 中的账户未计入此处的任何数字 — 此文件中没有可将它们合并计算的汇率。',
  ...
  'bx.doc.noteExactThrough': '范围止于 {to}；数字延续到生成当天，即 {through}。',
  'bx.doc.pageOf': '第 {n} 页，共 {m} 页',
  ...
  'acct.balance.impliedHint': { other: '交易合计为 {amount} — 其中 {count} 笔发生在你上次确认之后。' },
  'acct.balance.asAt': '截至哪一天？',
  'acct.balance.asAtDesc': '该金额成立的日期——对账单的日期，不一定是今天。此后日期的交易仍会计入余额。',
  'acct.balance.updatedDrift': { other: '已保存 {name} 的余额，但此后的 {count} 笔交易合计比保存的金额多或少 {amount}。打开账户查看。' },
  'acct.balance.unreadable': '无法读取“{raw}” — 点按修正',
  'acct.reconciled': '{name} 的余额已设为 {amount} — 与交易记录一致',
  'acct.toast.updated': '已更新 {name}',
  'acct.deck.ignore': '忽略',
  'acct.deck.ariaIgnore': '忽略 {name} 的此警告',
  'acct.toast.ignored': '{name}：此警告现已被忽略。可在“编辑”中撤销。',
  ...
  'acct.emergency.part': '保留已预留的 {amount}',
  'acct.field.limit': '信用额度',
  'acct.field.limitDesc': '在信用卡上显示已使用的额度比例。',
  ...
  'settings.exchangeRates.on': '开启 — 获取汇率',
  'settings.exchangeRates.desc': '默认关闭，也是本插件中唯一会发起网络请求的功能。开启后，它会按你在下方选择的频率向公开汇率服务请求当日汇率，将其保存为预算文件夹中的一则可读笔记，并把以其他货币持有的账户计入你的合计。它只发送货币代码——绝不发送你的余额或账户名称。每个换算后的金额都会印上其汇率的日期，超过一周的汇率会自行说明。',
  'settings.rateRefresh.name': '获取汇率的频率',
  'settings.rateRefresh.desc': '在上方开启汇率后，插件可以多久请求一次新汇率。每天是它一直以来的承诺。每周或每月意味着更少的请求——每个换算后的金额仍会印上其汇率的日期，因此你选择很少获取的汇率，依然会说明它有多旧。',
  'settings.rateRefresh.daily': '每天',
  ...
  'acct.deck.show': "显示它们",
  'acct.deck.groupReason.drift': "余额与交易不一致",
  'acct.deck.groupReason.stale': "余额已有一段时间未确认",
  'acct.deck.groupReason.unreadable': "部分交易的日期无法读取",
  'acct.deck.groupReason.nodate': "余额没有可读的确认日期",
  'acct.deck.groupReason.notx': "已关联文件夹，但尚未导入任何内容",
  'acct.deck.groupReason.nofolder': "没有任何内容导入这些账户，因此无法核对数字",
  ...
  'acct.table.otherCurrencies': '另加 {list}',
  'acct.col.account': '账户',
  'acct.col.balance': '余额',
  'acct.col.month': '周期',
  'acct.col.goal': '进度',
  ...
  'acct.state.ok': '一致',
  'acct.state.drift': '不匹配',
  'acct.state.unreadable': '日期无法读取',
  ...
  'acct.drawer.recon.stale': '上次确认于 {date}。确认后，核对将从今天重新开始。',
  'acct.drawer.recon.nodate': '尚无确认日期 — 设置日期后，即可将此金额与交易记录核对。',
  'acct.drawer.recon.notx': '已关联交易文件夹，但尚未导入任何内容。导入对账单后即可核对这个数字。',
  'acct.drawer.recon.nofolder': '没有任何内容导入此账户。关联交易文件夹后即可核对这个数字。',
  'acct.drawer.recon.unreadable': '这个数字暂时无法与你的交易核对。',
  ...
  'dash.hero.assumedIncluded': '含已支出的 {amount}',
  'dash.hero.nettedOff': '已抵扣退款 {amount}',
  'dash.stat.income': '收入合计',
  'dash.stat.budgeted': '预算',
  'dash.stat.spent': '支出合计',
  'dash.stat.uncategorised': '未分类',
  'dash.stat.allocated': '收入的 {pct}% 已编入预算',
  'dash.stat.allocatedOf': '本预算所计划收入 {amount} 的 {pct}%',
  'dash.stat.setAside': '预留 {amount}',
  'dash.stat.setAsideMoved': '预留 {amount}，已转入 {moved}',
  ...
  'dash.stat.notIncome': '{amount} 无分类入账 — 未计入此处',
  ...
  'dash.stale.driftUp': ' 此后的交易合计多出 {amount}。',
  'dash.stale.driftDown': ' 此后的交易合计少了 {amount}。',
  'dash.stale.btn': '查看余额',
  ...
  'dash.split.setAsideNote': ' · 预留 {amount}',
  ...
  'score.win.wealth': '你拥有的已远超所欠的。这是会自己悄悄增长的部分。',
  ...
  'score.now.wealth': '现在：净资产 {amount} · 相当于 {times} 年收入',
  ...
  'score.flow.overspent.name': "超支",
  'score.flow.overspent.sub': "你比收入多花了 {amount}",
  ...
  'score.flow.subA.overBudget': "超出预算 {amount} · {neverBudgeted} 从未纳入预算",
  ...
  'score.flow.chip.ofWhichInterest': '其中的利息',
  ...
  'score.flow.chip.allocatedOfIncome': '收入中已编入预算的比例',
  'score.flow.chip.spent': '已支出',
  'score.flow.chip.budgetUsed': '本周期预算已用',
  'score.flow.chip.budgetUsedNote': '仅本期 — 上方的分数使用六个周期的平均值。',
  'score.flow.chip.lefts': '剩余的钱 — 两种',
  ...
  'dash.left.earmarked': '已预留',
  'dash.left.earmarkedFrom': { other: '{count} 个专款', },
  'dash.left.free': '实际可用',
  'dash.left.short': '缺口',
  'dash.left.counted': {
    other: '{count} 个账户',
  ...
  'dash.left.confirmDay': {
    other: '确认日的 {count} 笔 ({amount}) 已包含在这些余额中',
  },
  'dash.left.orders': {
    other: '{count} 笔代扣',
  },
  ...
  'dash.left.barAriaSetAside': '在 {cash} 中，{earmarked} 已预留，{committed} 已承诺，{free} 可自由支配',
  ...
  'nav.report': '报告',
  'shell.tx.report': '报告',
  'report.pageSub': '一份 Markdown 笔记 · 在 Obsidian 中阅读、分享，或粘贴到 AI 对话中',
  'report.options.title': '报告选项',
  'report.field.period': '周期',
  'report.field.detail': '详细程度',
  'report.field.format': '格式',
  'report.field.folder': '文件夹',
  'report.field.folderDesc': '笔记的保存位置 — 会记住供下次使用。',
  'report.field.folderManaged': '这个位置在 {folder} 内，而这是本应用管理的文件夹 — 保存在这里的报告，会在下次加载库时被当作数据读入（例如变成一个新的分类）。请选择其他文件夹。',
  'report.period.current': '本月',
  'report.period.current.desc': '仅本预算周期。',
  'report.period.3m': '最近3个月',
  'report.period.3m.desc': '最近3个月，若保险库数据不够久远则取现有全部。',
  'report.period.12m': '最近12个月',
  ...
  'report.format.md.desc': '在 Obsidian 中阅读、分享，或在桌面应用中另存为 PDF。',
  'report.format.json': 'JSON',
  'report.format.json.desc': '原始数字与货币代码，适合偏好解析而非阅读的工具。',
  'report.format.pillsAria': '报告文件格式',
  'report.to': '至',
  'report.preview': '将创建：{path}',
  'report.exists': '此选择（{formats}）已存在报告 — 再次创建将覆盖它。',
  'report.create': '创建报告',
  'report.recreate': '重新创建报告（覆盖）',
  'report.contains.title': '本报告将包含：',
  'report.contains.incomeSpend': '收入与支出',
  'report.contains.category': '按分类的支出',
  'report.contains.budget': '预算与实际',
  'report.contains.savings': '储蓄与投资增长（截至今日）',
  'report.contains.debt': '债务状况（截至今日）',
  'report.contains.netWorth': '净资产（截至今日）',
  'report.contains.health': '财务健康评分（截至今日，若历史数据足够）',
  'report.contains.transactions': '列出该周期内的每一笔交易',
  'report.created': '报告已创建',
  'report.createdPartial': '报告部分创建 — 一个文件失败（{error}）',
  'report.createFailed': '无法创建报告（{error}）',
  'report.result.title': '报告已就绪',
  'report.result.generated': '生成于 {date}',
  'report.result.found': '已存在于磁盘上（来自之前的报告）',
  'report.open': '打开报告',
  'report.openFailed': '无法打开该报告 — 文件可能已被移动',
  'report.copy': '复制以供 AI 使用',
  'report.copyJson': '复制 JSON',
  'report.copied': '已复制到剪贴板',
  'report.copyFailed': '无法复制报告（{error}）',
  'report.shareHint': '要以其他方式发送，请打开该笔记并使用 Obsidian 自带的分享菜单。',
  ...
  'report.col.spend': '支出',
  'report.col.net': '净额',
  'report.col.budgetIncome': '预算收入',
  'report.col.budgetSpend': '预算支出',
  'report.section.category': '按分类的支出',
  ...
  'report.category.scheduled': {
    other: '本期日期较晚的 {count} 笔（{amount}）列在下方，但未计入上方合计。',
  },
  'report.health.otherCurrencies': '此评分未计入 {list}。',
  ...
  'report.col.percent': '%',
  'report.section.budgetActual': '预算与实际',
  'report.budget.empty': '本周期没有预算或支出记录。',
  'report.col.type': '类型',
  'report.col.budget': '预算',
  'report.col.actual': '实际',
  'report.col.remaining': '剩余',
  'report.section.savings': '储蓄与投资增长',
  'report.asOf': '_截至今日的数据 — 与上方周期无关；请参阅应用内此标题下的说明。_',
  'report.savings.none': '没有记录储蓄或投资账户。',
  'report.savings.unmeasured': '没有任何储蓄或投资账户设置了起始金额或起始日期，因此增长暂时无法计算。',
  ...
  'report.col.rate': '利率',
  'report.col.interest': '月利息',
  'report.section.netWorth': '净资产',
  'report.col.netWorth': '净资产',
  'report.col.owned': '拥有',
  'report.col.owed': '欠款',
  'report.section.health': '财务健康',
  'report.health.score': '评分',
  ...
  'assets.hero.totalLabel': "总价值",
  'assets.hero.items': { other: "{count} 项" },
  'assets.hero.largest': "最大",
  'assets.hero.badgeOk': "所有估值均为最新",
  'assets.hero.badgeWarn': { other: "{count} 项需要重新估值" },
  'assets.hero.heldAbroad': "另有 {list} 持有于海外，未换算",
  'assets.hero.largestAbroad': "海外最大 {list}，未换算",

  /* ------------------------- plan view (mobile redesign) ------------------------- */
  'plan.hero.leftToPlace': "待分配",
  'plan.hero.overPlaced': "分配的金额超过了该计划持有的金额",
  'plan.hero.overSpent': "支出超过了该计划持有的金额",
  'plan.hero.ofPot': "在该计划的 {pot} 中",
  'plan.hero.allIn': "全部今天都已到账",
  'plan.hero.noneIn': "还没有任何一笔到账",
  'plan.hero.partial': "{received} 今天已到账，{expected} 仍在等待中",
  'plan.hero.noSources': "还没有资金来源 — 添加为该计划提供资金的项目。",
  'plan.split.spokenFor': "已分配",
  'plan.split.notSpokenFor': "未分配",
  'plan.split.alreadySpent': "已花费",
  'plan.split.overspent': "超支",
  'plan.split.stillLeft': "仍可支出",
  'plan.source.editAria': "编辑资金来源 {name}",
  'plan.source.removeAria': "移除资金来源 {name}",
  'plan.source.inAccount': "在账户中",
  'plan.source.expected': "预计到账",
  'plan.source.noDate': "无日期",
  'plan.source.fieldName': "这是什么？",
  'plan.source.fieldKind': "类型",
  'plan.source.fieldKindDesc': "仅用于分组的标签 — 不改变任何计算。",
  'plan.source.fieldAmount': "金额",
  'plan.source.fieldDate': "什么时候到账？",
  'plan.source.fieldDateDesc': "未来的日期计入计划，但不计入今天可以花费的金额。",
  'plan.source.fieldStatus': "状态",
  'plan.source.statusReceived': "已到账",
  'plan.source.statusExpected': "预计到账",
  'plan.source.fieldNotes': "备注",
  'plan.source.fieldRemove': "移除此资金来源",
  'plan.source.fieldRemoveYes': "移除",
  'plan.env.expandAria': "展开 {name}",
  'plan.env.leftInBucket': "剩余 {amount}",
  'plan.env.allSpent': "已全部支出",
  'plan.env.nothingSpent': "尚未支出",
  'plan.env.collapseAria': "收起 {name}",
  'plan.env.deleteAria': "移除支出信封 {name}",
  'plan.actions.deleteAria': "删除计划",
