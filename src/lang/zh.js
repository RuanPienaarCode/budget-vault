...
module.exports = {
  ...
  'dash.health.why.title': '这个评分是怎么算的',
  'dash.health.why.intro': '你的评分满分 100，由你财务的五个方面组成。文件里看不到的内容会直接排除，绝不会扣分。',
  ...
  'dash.health.why.fullReserves': '为紧急情况预留的钱。如果收入中断，这笔钱能撑住 {target} 个月的必付开销（房租、饮食、交通）即为满分。',
  'dash.health.why.fullSaving': '你把多少收入存了下来。每月存下所赚的 {pct}% 即为满分。',
  'dash.health.why.fullDebt': '债务让你付出的代价。不付任何利息、没有贷款或信用卡还款即为满分。',
  'dash.health.why.fullSpending': '支出与收入的对比。固定账单（房租、保险、订阅）低于收入的 {fixed}%，全部日常生活开销低于 {living}%，且不超预算，即为满分。',
  'dash.health.why.fullWealth': '你拥有的一切（存款、投资、房产）减去你欠的一切（贷款、信用卡）。这个数达到 {times} 年收入即为满分。',
  ...
  'dash.health.why.dragLabel': '差距最大：{name}，{points} 分。',
  ...
  'dash.health.why.allFull': '能衡量的都已满分，没有什么拖累你。',
  'dash.health.why.aria': '财务评分 — 计算方式以及如何改善',
  ...
  'score.how.title': '评分的构成',
  'score.how.sub': '五个部分，各占 100 分的一部分',
  'score.how.worth': '占 {points} 分',
