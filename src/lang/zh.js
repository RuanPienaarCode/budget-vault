...
module.exports = {
  ...
  'dash.health.why.intro': '满分 100 的评分，来自你财务的五个方面。每个方面占总分的一部分。文件无法回答的方面会被排除，而不是记零分。',
  ...
  'dash.health.why.fullReserves': '目标：存下 {target} 个月的必要支出。',
  'dash.health.why.fullSaving': '目标：把收入的 {pct}% 存起来。',
  'dash.health.why.fullDebt': '目标：没有利息，也没有分期。',
  'dash.health.why.fullSpending': '目标：固定支出低于收入的 {fixed}%，生活成本低于 {living}%，支出不超预算。',
  'dash.health.why.fullWealth': '目标：资产减去负债达到一年收入的 {times} 倍。',
  'dash.health.why.fixTrim': '每月减少 {amount} 生活成本，就能低于收入的 {pct}%。',
  'dash.health.why.fixBuild': '资产再增加 {amount} 就能达到一年收入的 {times} 倍。',
  'dash.health.why.points': '{max} 分中的 {points} 分',
  'dash.health.why.dragLabel': '差距最大：{name}，{points} 分。',
  'dash.health.why.fixFund': '再往指定账户存入 {amount} 就能达到 {target} 个月。',
  'dash.health.why.fixMonthly': '每月多存 {amount} 就能达到 {pct}%。',
  'dash.health.why.fixInterest': '每月 {amount} 白白流走，还清就能把分数拿回来。',
