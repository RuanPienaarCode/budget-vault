...
module.exports = {
  ...
  'bx.range.12': '1年',
  'bx.range.all': 'すべて',
  'bx.includeCurrent': '現在の期間を含める',
  'bx.includeCurrent.desc': 'まだ進行中のため、その数値は期間の一部だけのものです。オフにすると、終了した期間だけを書き出します。',
  'bx.content': '書き出す内容',
  'bx.content.full': '予算全体',
  'bx.content.summary': 'カテゴリ別サマリー',
  'bx.content.full.desc': '月ごとのサマリー、続いて各期間の予算 — 計画した金額、使った金額、残った金額をカテゴリごとに。',
  'bx.content.summary.desc': '1つの表 — 各カテゴリが各期間でいくらになったかを、合計・平均・予算額とともに示します。',
  'bx.cats': 'カテゴリ',
  'bx.cats.all': 'すべてのカテゴリ',
  'bx.cats.pick': '選択…',
  'bx.cats.selectAll': 'すべて選択',
  'bx.cats.selectNone': '選択解除',
  'bx.cats.count': '{total} 件中 {count} 件を選択',
  'bx.includeTx': '取引を含める',
  'bx.includeTx.desc': '数値の背後にある個々の取引を、同じ期間・カテゴリで追加します。',
  'bx.format': 'ファイル形式',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — 読む、印刷する、送るのに。',
  'bx.format.xlsx.desc': 'Excel — テーブルごとに1シートのブック、金額は実数として。',
  'bx.format.csv.desc': 'CSV — テーブルごとの単純なファイル、他のプログラム用に。',
  'bx.folder': '保存先フォルダ',
  'bx.folder.desc': 'この保管庫内のフォルダ。同じ選択で再度書き出すと、以前のファイルが置き換わります。',
  'bx.cancel': 'キャンセル',
  'bx.go': '書き出す',
  'bx.preview': {
  ...
  'bx.dirty': '先に変更を保存してください — 未保存の編集を書き出すと保管庫の内容と一致しません',
  'bx.failed': '書き出しに失敗しました（{error}） — フォルダ名を確認してください',
  'bx.failedPartial': {
    other: '{count} 件のファイルの後で書き出しが止まりました（{error}）',
  },
  'bx.done': {
    other: '{count} 件のファイルを {path}/ に書き出しました',
  },
  'bx.done.title': '予算を書き出しました',
  'bx.done.open': '開く',
  'bx.done.reveal': 'ファイルエクスプローラーで表示',
  'bx.done.close': '完了',
  'bx.done.hint': 'ファイルは保管庫内にあります。送るには、開くかファイルエクスプローラーで見つけて、デバイスの共有または保存の機能を使ってください。',
  'bx.done.raster': 'この書き出しの一部のテキストは、内蔵のPDFフォントでは描画できない文字を含んでいるため、PDFのページは画像として保存されました。見た目は同じですが、テキストの選択や検索はできません。ExcelとCSVのファイルには影響しません。',
  'bx.doc.title': '予算',
  'bx.doc.titleSummary': '予算サマリー',
  'bx.doc.category': 'カテゴリ',
  'bx.doc.type': '種類',
  'bx.doc.total': '合計',
  'bx.doc.average': '平均',
  'bx.doc.budgeted': '予算額',
  ...
  'bx.doc.notes': 'メモ',
  'bx.doc.date': '日付',
  'bx.doc.description': '摘要',
  'bx.doc.account': '口座',
  'bx.doc.currency': '通貨',
  'bx.doc.amount': '金額',
  'bx.doc.flag': 'フラグ',
  'bx.doc.excluded': '除外',
  'bx.doc.splitParent': '分割元',
  'bx.doc.splitPart': '分割分',
  'bx.doc.subtotal': '{type}合計',
  'bx.doc.summaryHeading': 'カテゴリ別サマリー',
  'bx.doc.transactionsHeading': '取引',
  'bx.doc.generated': '作成日時',
  'bx.doc.range': '期間',
  'bx.doc.categories': 'カテゴリ',
  'bx.doc.allCategories': 'すべてのカテゴリ',
  'bx.doc.periodLine': '収入 {income} · 支出 {spend}',
  'bx.doc.periodUncat': ' · 未分類 {uncat}',
  'bx.doc.noteFilter': 'これらのカテゴリのみが含まれます: {list}。合計は記載したカテゴリのみを対象とし、予算全体ではありません。',
  'bx.doc.noteForeign': '{list} の口座はここのどの数値にも含まれていません — このファイルにはそれらを合算するための為替レートがありません。',
  ...
  'bx.doc.amountsIn': '金額の単位: {currency}',
  'bx.doc.noteNoBudget': 'この期間には予算が設定されていないため、実績のみを表示しています。',
  ...
  'dash.hero.assumedIncluded': '支出済みの {amount} を含む',
  'dash.hero.nettedOff': '返金 {amount} を相殺',
  ...
  'dash.split.setAsideNote': ' · {amount} を取り置き',
  ...
  'plan.hero.overSpent': "このプランが持つ額より多く使われています",
  ...
  'plan.split.overspent': "使いすぎ",
  'plan.split.stillLeft': "まだ使える残り",
  ...
  'plan.env.leftInBucket': "残り {amount}",
  'plan.env.allSpent': "すべて使用済み",
  'plan.env.nothingSpent': "まだ何も使っていません",
