...
module.exports = {
  ...
  'dash.health.why.intro': 'お金の5つの面から出す100点満点のスコアです。各面が全体の一定割合を占めます。ファイルから分からない面は0点ではなく対象外です。',
  ...
  'dash.health.why.fullReserves': '目標: 必要支出 {target} か月分の貯え。',
  'dash.health.why.fullSaving': '目標: 収入の {pct}% を貯蓄。',
  'dash.health.why.fullDebt': '目標: 利息も返済もゼロ。',
  'dash.health.why.fullSpending': '目標: 固定費は収入の {fixed}% 未満、生活費は {living}% 未満、支出は予算内。',
  'dash.health.why.fullWealth': '目標: 資産から負債を引いた額が年収の {times} 倍。',
  'dash.health.why.fixTrim': '生活費を月 {amount} 減らすと収入の {pct}% を下回ります。',
  'dash.health.why.fixBuild': '資産をあと {amount} 増やすと年収の {times} 倍に届きます。',
  'dash.health.why.points': '{max} 点中 {points} 点',
  'dash.health.why.dragLabel': '最大の差: {name}、{points} 点。',
  'dash.health.why.fixFund': '指定口座にあと {amount} 入れると {target} か月に届きます。',
  'dash.health.why.fixMonthly': '毎月あと {amount} 貯めると {pct}% に届きます。',
  'dash.health.why.fixInterest': '毎月 {amount} が何も生んでいません。減らせば点が戻ります。',
