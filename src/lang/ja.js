...
module.exports = {
  ...
  'dash.health.why.title': 'このスコアの仕組み',
  'dash.health.why.intro': 'お金の5つの面から組み立てた100点満点のスコアです。ファイルから分からないことは単に対象外になり、減点にはなりません。',
  ...
  'dash.health.why.fullReserves': '緊急時のために取り分けてあるお金です。収入が止まっても、家賃・食費・交通費など必ず払う支出を {target} か月分まかなえれば満点です。',
  'dash.health.why.fullSaving': '収入のうちどれだけ貯めているかです。毎月、稼いだ額の {pct}% を貯めていれば満点です。',
  'dash.health.why.fullDebt': '借金にかかる費用です。利息を払っておらず、ローンやカードの返済もなければ満点です。',
  'dash.health.why.fullSpending': '支出を収入と比べたものです。固定費（家賃・保険・サブスク）が収入の {fixed}% 未満、日々の生活費すべてが {living}% 未満で、予算内に収まっていれば満点です。',
  'dash.health.why.fullWealth': '持っているもの（貯金・投資・不動産）すべてから、借りているもの（ローン・カード）すべてを引いた額です。それが年収の {times} 年分になれば満点です。',
  ...
  'dash.health.why.dragLabel': '最大の差: {name}、{points} 点。',
  ...
  'dash.health.why.allFull': '測れるものはすべて満点です。妨げはありません。',
  'dash.health.why.aria': '家計スコア — 算出方法と改善につながる点',
  ...
  'score.how.title': 'スコアの組み立て',
  'score.how.sub': '5つの面が、それぞれ 100 点の一部を占めます',
  'score.how.worth': '{points} 点分',
