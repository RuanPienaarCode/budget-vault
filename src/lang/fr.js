...
module.exports = {
  ...
  'dash.health.why.intro': 'Un score sur 100, à partir de cinq volets de votre argent. Chaque volet vaut une part du total. Ce que vos fichiers ne peuvent pas dire est écarté, pas noté zéro.',
  ...
  'dash.health.why.fullReserves': 'Objectif : {target} mois de dépenses essentielles épargnés.',
  'dash.health.why.fullSaving': 'Objectif : épargner {pct}% de ce que vous gagnez.',
  'dash.health.why.fullDebt': 'Objectif : aucun intérêt et aucune mensualité.',
  'dash.health.why.fullSpending': 'Objectif : charges fixes sous {fixed}% des revenus, coût de la vie sous {living}%, dépenses dans le budget.',
  'dash.health.why.fullWealth': 'Objectif : ce que vous possédez, moins vos dettes, atteint {times}× une année de revenus.',
  'dash.health.why.fixTrim': 'Réduisez le coût de la vie de {amount} par mois pour passer sous {pct}%.',
  'dash.health.why.fixBuild': 'Faites croître ce que vous possédez de {amount} pour atteindre {times}× une année de revenus.',
  'dash.health.why.points': '{points} sur {max}',
  'dash.health.why.dragLabel': 'Plus grand écart : {name}, {points} points.',
  'dash.health.why.fixFund': 'Placez {amount} de plus sur un compte réservé pour atteindre {target} mois.',
  'dash.health.why.fixMonthly': 'Épargnez {amount} de plus par mois pour atteindre {pct}%.',
  'dash.health.why.fixInterest': 'Ce sont {amount} par mois pour rien : les rembourser récupère les points.',
