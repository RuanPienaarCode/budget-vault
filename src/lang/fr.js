...
module.exports = {
  ...
  'acct.balance.impliedHint': 'Vos opérations impliquent {amount} après {count} ligne(s) depuis votre dernière confirmation.',
  ...
  'acct.balance.updatedDrift': 'Solde de {name} enregistré — mais {count} ligne(s) depuis cette date diffèrent de {amount}. Ouvrez le compte pour les voir.',
