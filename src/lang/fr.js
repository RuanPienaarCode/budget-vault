...
module.exports = {
  ...
  'acct.balance.impliedHint': { one: 'Vos opérations impliquent {amount} après {count} ligne depuis votre dernière confirmation.', other: 'Vos opérations impliquent {amount} après {count} lignes depuis votre dernière confirmation.' },
  ...
  'acct.mute.drift': 'Le solde s\'est écarté des opérations',
  ...
  'acct.emergency.part': 'Conserver la réserve de {amount}',
  ...
  'acct.hero.oldest': 'Chiffre le plus ancien',
  ...
  'acct.drawer.recon.stale': 'Confirmé le {date}. Le confirmer relance la fenêtre de rapprochement.',
  'acct.drawer.recon.nodate': 'Pas encore de date confirmée — le rapprochement en a besoin avant de pouvoir vérifier ce compte.',
  ...
  'dash.health.meterTip': {
    one: '{earmarked} sur les {goal} qui couvrent {count} mois',
    other: '{earmarked} sur les {goal} qui couvrent {count} mois',
  },
  'dash.health.monthsMeta': {
    one: 'Objectif {count} mois · {amount} réservé',
    other: 'Objectif {count} mois · {amount} réservé',
  },
  ...
  'dash.health.over': '{name} réserve plus qu’il ne contient',
  ...
  'score.flow.chip.allocatedOfIncome': 'Part des revenus allouée',
  ...
  'score.flow.chip.lefts': 'Deux "restes" différents',
