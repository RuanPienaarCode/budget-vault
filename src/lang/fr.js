...
module.exports = {
  ...
  'dash.health.months': 'mois de dépenses essentielles couverts',
  'dash.health.monthsMeta': 'objectif {target} · {amount} réservé',
  ...
  'dash.health.why.intro': 'Un nombre sur 100, à partir de cinq volets de vos finances. Chaque volet vaut une part du total, et vous gagnez ses points à proportion de votre distance au maximum. Un volet auquel vos fichiers ne peuvent pas répondre est écarté plutôt que noté zéro.',
  'dash.health.why.bands': '{strong} et plus est solide · {steady}–{strongLess} est stable · en dessous de {steady} demande de l’attention',
  ...
  'dash.health.why.fullReserves': 'Maximum atteint avec {target} mois de dépenses essentielles mis de côté.',
  'dash.health.why.fullSaving': 'Maximum atteint en épargnant {pct}% de vos revenus.',
  'dash.health.why.fullDebt': 'Maximum si rien ne part en intérêts et qu’aucune mensualité n’est à porter.',
  'dash.health.why.fullSpending': 'Maximum avec moins de {fixed}% de revenus en charges fixes, un coût de la vie sous {living}% et des dépenses dans votre budget.',
  'dash.health.why.fullWealth': 'Maximum à un patrimoine net de {times}× vos revenus annuels — tout ce que vous possédez, moins tout ce que vous devez.',
  'dash.health.why.fixTrim': 'Réduire le coût de la vie de {amount} par mois le ferait passer sous {pct}% des revenus.',
  'dash.health.why.fixBuild': '{amount} de patrimoine net en plus atteindrait {times}× vos revenus annuels.',
  'dash.health.why.points': '{points} sur {max}',
  'dash.health.why.dragLabel': 'Ce qui vous coûte le plus : {name}, {points} points.',
  'dash.health.why.fixFund': 'Ajouter {amount} à un compte réservé atteindrait {target} mois et récupérerait ces points.',
  'dash.health.why.fixMonthly': 'Mettre {amount} de plus par mois de côté atteindrait {pct}% et récupérerait ces points.',
  'dash.health.why.fixInterest': 'Ce sont {amount} par mois qui ne vous rapportent rien — chaque part remboursée revient en points.',
  'dash.health.why.allFull': 'Tous les volets mesurables sont au maximum. Rien ici ne vous freine.',
