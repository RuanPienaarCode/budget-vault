...
module.exports = {
  ...
  'dash.health.why.title': 'Comment ce score est calculé',
  'dash.health.why.intro': 'Votre score sur 100, construit à partir de cinq volets de votre argent. Ce que vos fichiers ne peuvent pas montrer est simplement écarté : cela ne joue jamais contre vous.',
  ...
  'dash.health.why.fullReserves': 'L’argent mis de côté pour les urgences. Note maximale quand il couvrirait {target} mois de dépenses incontournables (loyer, nourriture, transport) si vos revenus s’arrêtaient.',
  'dash.health.why.fullSaving': 'La part de vos revenus que vous mettez de côté. Note maximale quand vous épargnez {pct}% de ce que vous gagnez chaque mois.',
  'dash.health.why.fullDebt': 'Ce que vos dettes vous coûtent. Note maximale quand vous ne payez aucun intérêt et n’avez aucune mensualité de prêt ou de carte.',
  'dash.health.why.fullSpending': 'Vos dépenses comparées à vos revenus. Note maximale quand les charges fixes (loyer, assurances, abonnements) restent sous {fixed}%, tout le quotidien sous {living}%, et que vous restez dans votre budget.',
  'dash.health.why.fullWealth': 'Tout ce que vous possédez (épargne, placements, immobilier) moins tout ce que vous devez (prêts, cartes). Note maximale quand cela représente {times} années de revenus.',
  ...
  'dash.health.why.dragLabel': 'Plus grand écart : {name}, {points} points.',
  ...
  'dash.health.why.allFull': 'Tout ce qui est mesurable est au maximum. Rien ne vous freine.',
  'dash.health.why.aria': 'Score financier — comment il est calculé et ce qui l’améliorerait',
  ...
  'score.how.title': 'Comment le score est construit',
  'score.how.sub': 'Cinq volets, chacun une part de 100',
  'score.how.worth': 'vaut {points}',
