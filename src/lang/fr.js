...
module.exports = {
  ...
  'wiz.folder.notVault': 'Un dossier dans ce coffre, pas un coffre à part. L’ouvrir comme un coffre à part masque le plugin.',
  ...
  'wiz.rates.on.desc': 'Le module demande à un service public de taux de change les taux du jour et les enregistre sous forme de note dans votre coffre — une fois par jour pour commencer, ce que vous pouvez passer à hebdomadaire ou mensuel dans les Paramètres. Il n\'envoie qu\'un code de devise — jamais vos soldes, vos comptes ou quoi que ce soit d\'autre. Chaque montant converti est affiché avec la date de son taux.',
  ...
  'wiz.ccy.euro': '€ — Euro',
  'wiz.ccy.pound': '£ — Livre',
  'wiz.ccy.rupee': '₹ — Roupie indienne',
  'wiz.ccy.rupiah': 'Rp — Roupie indonésienne',
  'wiz.ccy.real': 'R$ — Réal brésilien',
  'wiz.ccy.other': 'Autre…',
  ...
  'bx.title': 'Exporter le budget',
  'bx.mode': 'Période',
  'bx.mode.months': 'Mois précédents',
  'bx.mode.dates': 'Plage de dates',
  'bx.preset.taxThis': 'Cette année fiscale',
  'bx.preset.taxLast': 'Année fiscale précédente',
  'bx.preset.calThis': 'Cette année',
  'bx.preset.calLast': 'L\'année dernière',
  'bx.preset.custom': 'Personnalisé',
  'bx.dates.from': 'Du',
  'bx.dates.to': 'Au',
  'bx.dates.desc': 'Les dépenses et les transactions utilisent exactement ces dates. Les tableaux de budget montrent chaque période de budget complète se terminant dans cet intervalle — un budget n\'est jamais scindé sur une date.',
  'bx.previewDates': {
    one: '{range} · {count} période budgétaire · {cats} catégories',
    other: '{range} · {count} périodes budgétaires · {cats} catégories',
  },
  'bx.problem.badDates': 'Choisissez une date de début et une date de fin, la date de début en premier.',
  'bx.range': 'Jusqu\'où remonter',
  'bx.range.1': '1 mois',
  'bx.range.2': '2 mois',
  'bx.range.3': '3 mois',
  'bx.range.6': '6 mois',
  'bx.range.12': '1 an',
  'bx.range.all': 'Tout',
  'bx.includeCurrent': 'Inclure la période en cours',
  'bx.includeCurrent.desc': 'Elle est encore en cours, donc ses chiffres ne couvrent qu\'une partie d\'une période. Désactivez pour n\'exporter que les périodes terminées.',
  'bx.content': 'Que faut-il exporter',
  'bx.content.full': 'Budget complet',
  'bx.content.summary': 'Résumé par catégorie',
  'bx.content.full.desc': 'Un résumé mois par mois, puis le budget de chaque période : ce qui était prévu, ce qui a été dépensé et ce qu\'il restait, par catégorie.',
  'bx.content.summary.desc': 'Un tableau : ce qu\'a fait chaque catégorie dans chaque période, avec un total, une moyenne et le montant budgété.',
  'bx.cats': 'Catégories',
  'bx.cats.all': 'Toutes les catégories',
  'bx.cats.pick': 'Choisir…',
  'bx.cats.selectAll': 'Tout sélectionner',
  'bx.cats.selectNone': 'Tout désélectionner',
  'bx.cats.count': '{count} sur {total} sélectionnées',
  'bx.includeTx': 'Inclure les transactions',
  'bx.includeTx.desc': 'Ajoute les transactions individuelles derrière les chiffres, pour les mêmes périodes et catégories.',
  'bx.format': 'Type de fichier',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — à lire, imprimer ou envoyer.',
  'bx.format.xlsx.desc': 'Excel — un classeur avec une feuille par tableau, montants en nombres réels.',
  'bx.format.csv.desc': 'CSV — un fichier simple par tableau, pour un autre programme.',
  'bx.folder': 'Enregistrer dans le dossier',
  'bx.folder.desc': 'Un dossier dans ce coffre. Exporter à nouveau la même sélection remplace les fichiers précédents.',
  'bx.cancel': 'Annuler',
  'bx.go': 'Exporter',
  'bx.preview': {
    one: '{count} période · {range} · {cats} catégories',
    other: '{count} périodes · {range} · {cats} catégories',
  },
  'bx.replaces': {
    one: 'Ceci remplace un fichier déjà présent : {files}',
    other: 'Ceci remplace {count} fichiers déjà présents : {files}',
  },
  'bx.problem.configDir': 'Ce dossier se trouve dans {folder}, où Obsidian conserve ses propres réglages — les fichiers qui s\'y trouvent n\'apparaissent pas dans votre coffre. Choisissez un autre dossier.',
  'bx.problem.noPeriods': 'Il n\'y a encore aucune période terminée avec des données — activez « Inclure la période en cours ».',
  'bx.problem.noCats': 'Choisissez au moins une catégorie.',
  'bx.problem.noRows': 'Rien à exporter — aucun budget ni dépense dans les catégories choisies pour cette période.',
  'bx.dirty': 'Enregistrez d\'abord vos modifications — un export de modifications non enregistrées ne correspondrait pas au coffre',
  'bx.failed': 'Impossible d\'écrire l\'export ({error}) — vérifiez le nom du dossier',
  'bx.failedPartial': {
    one: 'L\'export s\'est arrêté après {count} fichier ({error})',
    other: 'L\'export s\'est arrêté après {count} fichiers ({error})',
  },
  'bx.done': {
    one: '{count} fichier exporté vers {path}/',
    other: '{count} fichiers exportés vers {path}/',
  },
  'bx.done.title': 'Budget exporté',
  'bx.done.open': 'Ouvrir',
  'bx.done.reveal': 'Afficher dans l\'explorateur de fichiers',
  'bx.done.close': 'Terminé',
  'bx.done.hint': 'Les fichiers sont dans votre coffre. Pour en envoyer un, ouvrez-le ou trouvez-le dans l\'explorateur de fichiers et utilisez l\'option de partage ou d\'enregistrement de votre appareil.',
  'bx.done.raster': 'Une partie du texte de cet export utilise des caractères que la police PDF intégrée ne peut pas dessiner, donc les pages du PDF ont été enregistrées en images. Elles se ressemblent, mais leur texte ne peut pas être sélectionné ni recherché. Les fichiers Excel et CSV ne sont pas concernés.',
  'bx.doc.title': 'Budget',
  'bx.doc.titleSummary': 'Résumé du budget',
  'bx.doc.category': 'Catégorie',
  'bx.doc.type': 'Type',
  'bx.doc.total': 'Total',
  'bx.doc.average': 'Moyenne',
  'bx.doc.budgeted': 'Budgété',
  'bx.doc.period': 'Période',
  'bx.doc.from': 'Du',
  'bx.doc.to': 'Au',
  'bx.doc.budget': 'Budget',
  'bx.doc.actual': 'Réel',
  'bx.doc.remaining': 'Restant',
  'bx.doc.used': 'Utilisé',
  'bx.doc.notes': 'Notes',
  'bx.doc.date': 'Date',
  'bx.doc.description': 'Description',
  'bx.doc.account': 'Compte',
  'bx.doc.currency': 'Devise',
  'bx.doc.amount': 'Montant',
  'bx.doc.flag': 'Repère',
  'bx.doc.excluded': 'exclue',
  'bx.doc.splitParent': 'parent réparti',
  'bx.doc.splitPart': 'partie répartie',
  'bx.doc.subtotal': 'Total {type}',
  'bx.doc.summaryHeading': 'Résumé par catégorie',
  'bx.doc.transactionsHeading': 'Transactions',
  'bx.doc.generated': 'Généré',
  'bx.doc.range': 'Période',
  'bx.doc.categories': 'Catégories',
  'bx.doc.allCategories': 'Toutes les catégories',
  'bx.doc.periodLine': 'Revenus {income} · Dépenses {spend}',
  'bx.doc.periodUncat': ' · Non catégorisé {uncat}',
  'bx.doc.noteFilter': 'Seules ces catégories sont incluses : {list}. Les totaux couvrent les catégories listées, pas tout le budget.',
  'bx.doc.noteForeign': 'Les comptes en {list} ne sont inclus dans aucun chiffre ici — il n\'y a pas de taux de change dans ce fichier pour les combiner.',
  ...
  'bx.doc.noteExactThrough': 'L\'intervalle se termine le {to} ; les chiffres vont jusqu\'au {through}, le jour où ceci a été généré.',
  'bx.doc.pageOf': 'Page {n} sur {m}',
  ...
  'acct.deck.ignore': 'Ignorer',
  'acct.deck.ariaIgnore': 'Ignorer cet avertissement sur {name}',
  'acct.toast.ignored': '{name} : cet avertissement est désormais ignoré. Annulez-le dans Modifier.',
  ...
  'acct.badge.currencyClash': 'lu comme {code}, pas {symbol}',
  'acct.drawer.currencyClash': 'Conflit de devise',

  'acct.recon.pending': {
    one: ' · {count} datée en avance, pas encore comptée',
    other: ' · {count} datées en avance, pas encore comptées',
  },
  'acct.recon.undatable': { one: ' · {count} transaction portant une date que cette application ne peut pas lire, dans aucune des deux fenêtres', other: ' · {count} transactions portant des dates que cette application ne peut pas lire, dans aucune des deux fenêtres' },
  ...
  'acct.hero.converted': ' Plus {list} — converti sur la ligne ci-dessus aux taux du {date}.',
  'acct.hero.convertedTotal': 'Total converti {amount}',
  'acct.hero.convertedStale': ' Plus {list} — converti sur la ligne ci-dessus aux taux du {date}, vieux de {days} jours.',
  'acct.hero.otherCurrencies': ' Plus {list} détenus dans d\'autres devises, non convertis.',
  'report.debt.otherCurrencies': ' Plus {list} dus dans d\'autres devises, non convertis.',
  ...
  'settings.exchangeRates.on': 'Activé — récupérer les taux de change',
  'settings.exchangeRates.desc': 'Désactivé par défaut, et la seule chose dans ce module qui effectue une requête réseau. Activé, il demande à un service public de taux de change les taux du jour aussi souvent que vous le choisissez ci-dessous, les enregistre sous forme de note lisible dans votre dossier de budget, et ajoute à vos totaux les comptes détenus dans d\'autres devises. Il n\'envoie qu\'un code de devise — jamais vos soldes ni les noms de vos comptes. Chaque montant converti est imprimé avec la date de son taux, et un taux vieux de plus d\'une semaine le signale.',
  'settings.rateRefresh.name': 'Fréquence de récupération des taux',
  'settings.rateRefresh.desc': 'À quelle fréquence le module peut demander de nouveaux taux, lorsque les taux de change sont activés ci-dessus. Quotidien est ce qu\'il a toujours promis. Hebdomadaire ou mensuel signifie moins de requêtes — chaque montant converti affiche toujours la date de son taux, donc un taux que vous avez choisi de récupérer rarement dit quand même quel âge il a.',
  'settings.rateRefresh.daily': 'Quotidien',
  'settings.rateRefresh.weekly': 'Hebdomadaire',
  'settings.rateRefresh.monthly': 'Mensuel',
  ...
  'acct.deck.why.unreadable': { one: '{count} transaction porte une date que cette application ne peut pas lire, le solde ne peut donc pas être vérifié par rapport à elle', other: '{count} transactions portent des dates que cette application ne peut pas lire, le solde ne peut donc pas être vérifié par rapport à elles' },
  ...
  'acct.deck.show': "Les afficher",
  'acct.deck.groupReason.drift': "Le solde ne correspond pas aux transactions",
  'acct.deck.groupReason.stale': "Le solde n'a pas été confirmé depuis un moment",
  'acct.deck.groupReason.unreadable': "Certaines transactions portent une date que rien ne peut lire",
  'acct.deck.groupReason.nodate': "Le solde n'a pas de date de confirmation lisible",
  'acct.deck.groupReason.notx': "Un dossier est lié, mais rien n'y a encore été importé",
  'acct.deck.groupReason.nofolder': "Rien n'est importé dans ces comptes, rien ne peut donc vérifier le chiffre",
  ...
  'acct.state.unreadable': 'date illisible',
  ...
  'acct.drawer.recon.unreadable': 'Ce chiffre ne peut pas encore être vérifié par rapport à vos opérations.',
  ...
  'acct.drawer.ahead': 'À venir',
  'acct.drawer.aheadRows': { one: '{count} opération datée plus tard dans cette période', other: '{count} opérations datées plus tard dans cette période', },
  ...
  'dash.hero.assumedIncluded': 'dont {amount} déjà dépensé',
  'dash.hero.nettedOff': '{amount} de remboursements déduits',
  ...
  'dash.stat.allocatedOf': '{pct}% des {amount} de revenus que ce budget prévoit',
  'dash.stat.setAside': '{amount} mis de côté',
  'dash.stat.setAsideMoved': '{amount} mis de côté, {moved} déjà versés',
  ...
  'dash.fundedFromSavings': {
    ...
    other: '{amount} de plus est sorti de vos réserves ({count} opérations), non comptés dans ce budget',
  },
  ...
  'dash.split.setAsideNote': ' · {amount} mis de côté',
  ...
  'score.flow.overspent.name': "Dépassement",
  'score.flow.overspent.sub': "Vous avez dépensé {amount} de plus que ce qui est entré",
  ...
  'score.flow.subA.overBudget': "{amount} au-delà du budget · {neverBudgeted} jamais budgétisé",
  ...
  'score.flow.chip.budgetUsed': 'Budget utilisé sur cette période',
  ...
  'dash.left.earmarked': 'mis de côté',
  'dash.left.earmarkedFrom': { one: '{count} réserve', other: '{count} réserves', },
  ...
  'dash.left.confirmDay': {
    one: '{count} opération à la date de confirmation ({amount}) est déjà comprise dans ces soldes',
    other: '{count} opérations à la date de confirmation ({amount}) sont déjà comprises dans ces soldes',
  },
  'dash.left.orders': {
  ...
  'dash.left.barAriaSetAside': 'Sur {cash}, {earmarked} est mis de côté, {committed} engagé et {free} libre',
  ...
  'dash.left.overdue': 'était dû le {date}',
  ...
  'nav.report': 'Rapport',
  'shell.tx.report': 'Rapport',
  'report.pageSub': 'Une note Markdown · à lire dans Obsidian, à partager, ou à coller dans une conversation IA',
  'report.options.title': 'Options du rapport',
  'report.field.period': 'Période',
  'report.field.detail': 'Détail',
  'report.field.format': 'Format',
  'report.field.folder': 'Dossier',
  'report.field.folderDesc': 'Où la note est écrite — mémorisé pour la prochaine fois.',
  'report.field.folderManaged': 'Ceci se trouve dans {folder}, un dossier géré par cette application — un rapport enregistré ici serait relu comme des données (par exemple une nouvelle catégorie) au prochain chargement du coffre. Choisissez un autre dossier.',
  'report.period.current': 'Mois en cours',
  'report.period.current.desc': 'Cette période budgétaire uniquement.',
  'report.period.3m': '3 derniers mois',
  'report.period.3m.desc': 'Les 3 derniers mois, ou moins si le vault ne remonte pas aussi loin.',
  'report.period.12m': '12 derniers mois',
  ...
  'report.format.md.desc': 'À lire dans Obsidian, à partager, ou à ouvrir en PDF depuis l\'appli de bureau.',
  'report.format.json': 'JSON',
  'report.format.json.desc': 'Chiffres bruts et un code de devise, pour un outil qui préfère analyser que lire.',
  'report.format.pillsAria': 'Format de fichier du rapport',
  'report.to': 'à',
  'report.preview': 'Sera créé : {path}',
  'report.exists': 'Existe déjà pour cette sélection ({formats}) — le recréer l\'écrasera.',
  'report.create': 'Créer le rapport',
  'report.recreate': 'Recréer le rapport (écraser)',
  'report.contains.title': 'Ce rapport comprendra :',
  'report.contains.incomeSpend': 'Revenus contre dépenses',
  'report.contains.category': 'Dépenses par catégorie',
  'report.contains.budget': 'Budget contre réel',
  'report.contains.savings': 'Croissance de l\'épargne et des placements (à ce jour)',
  'report.contains.debt': 'Situation d\'endettement (à ce jour)',
  'report.contains.netWorth': 'Valeur nette (à ce jour)',
  'report.contains.health': 'Score de santé financière (à ce jour), si l\'historique le permet',
  'report.contains.transactions': 'Chaque transaction de la période, listée',
  'report.created': 'Rapport créé',
  'report.createdPartial': 'Rapport partiellement créé — un fichier a échoué ({error})',
  'report.createFailed': 'Impossible de créer le rapport ({error})',
  'report.result.title': 'Rapport prêt',
  'report.result.generated': 'Généré {date}',
  'report.result.found': 'Déjà sur le disque, issu d\'un rapport précédent',
  'report.open': 'Ouvrir le rapport',
  'report.openFailed': 'Impossible d\'ouvrir ce rapport — le fichier a peut-être été déplacé',
  'report.copy': 'Copier pour l\'IA',
  'report.copyJson': 'Copier le JSON',
  'report.copied': 'Copié dans le presse-papiers',
  'report.copyFailed': 'Impossible de copier le rapport ({error})',
  'report.shareHint': 'Pour l\'envoyer autrement, ouvrez la note et utilisez le menu de partage propre à Obsidian.',
  ...
  'report.col.net': 'Net',
  'report.col.budgetIncome': 'Revenus budgétés',
  'report.col.budgetSpend': 'Dépenses budgétées',
  'report.section.category': 'Dépenses par Catégorie',
  ...
  'report.category.scheduled': {
    one: '{count} opération datée plus tard dans cette période ({amount}) est listée ci-dessous mais n’est pas comptée dans les totaux ci-dessus.',
    other: '{count} opérations datées plus tard dans cette période ({amount}) sont listées ci-dessous mais ne sont pas comptées dans les totaux ci-dessus.',
  },
  'report.health.otherCurrencies': 'Ce score a été calculé sans {list}.',
  ...
  'report.col.percent': '%',
  'report.section.budgetActual': 'Budget contre Réel',
  'report.budget.empty': 'Aucun budget ni dépense enregistrés pour cette période.',
  'report.col.type': 'Type',
  'report.col.budget': 'Budget',
  'report.col.actual': 'Réel',
  'report.col.remaining': 'Restant',
  'report.section.savings': 'Croissance de l\'Épargne et des Placements',
  'report.asOf': '_À ce jour — sans lien avec la période ci-dessus ; voir la note sous ce titre dans l\'appli._',
  'report.savings.none': 'Aucun compte d\'épargne ou de placement enregistré.',
  'report.savings.unmeasured': 'Aucun compte d\'épargne ou de placement n\'a de montant de départ ou de date de début défini, la croissance ne peut donc pas encore être mesurée.',
  ...
  'report.debt.free': {
    one: 'Sans dette — {count} dette suivie, remboursée.',
    other: 'Sans dette — {count} dettes suivies, toutes remboursées.',
  },
  ...
  'report.col.interest': 'Intérêts mensuels',
  'report.section.netWorth': 'Valeur Nette',
  'report.col.netWorth': 'Valeur nette',
  'report.col.owned': 'Possédé',
  'report.col.owed': 'Dû',
  'report.section.health': 'Santé Financière',
  ...
  'report.transactions.count': {
    ...
    other: '{count} transactions sur cette période.',
  },

  /* --- second pass: topbar report button + up-front copy + reveal-in-folder --- */
  'topbar.report': 'Générer un rapport',
  'topbar.reportTitle': 'Générer un rapport financier',
  'report.copyNow': 'Copier le rapport',
  'report.reveal': 'Ouvrir le dossier du rapport',
  'report.revealNone': 'Rien à afficher pour l\'instant — créez d\'abord un rapport.',
  'report.revealUnavailable': 'L\'explorateur de fichiers est désactivé dans Obsidian, ce rapport ne peut donc pas y être affiché.',
  'report.revealFailed': 'Impossible d\'afficher ce rapport ({error})',

  /* ------------------------- assets page hero (redesign) ------------------------- */
  'assets.hero.totalLabel': "Valeur totale",
  'assets.hero.items': { one: "{count} élément", other: "{count} éléments" },
  'assets.hero.largest': "le plus important",
  'assets.hero.badgeOk': "toutes les valeurs à jour",
  'assets.hero.badgeWarn': { one: "{count} a besoin d'une nouvelle estimation", other: "{count} ont besoin d'une nouvelle estimation" },
  'assets.hero.heldAbroad': "plus {list} détenus à l'étranger, non convertis",
  'assets.hero.largestAbroad': "le plus important à l'étranger {list}, non converti",

  /* ------------------------- plan view (mobile redesign) ------------------------- */
  'plan.hero.leftToPlace': "Reste à répartir",
  'plan.hero.overPlaced': "Plus réparti que ce que ce plan contient",
  'plan.hero.overSpent': "Dépensé plus que ce que ce plan contient",
  'plan.hero.ofPot': "sur {pot} dans ce plan",
  'plan.hero.allIn': "la totalité est aujourd'hui sur le compte",
  'plan.hero.noneIn': "rien n'est encore arrivé",
  'plan.hero.partial': "{received} est aujourd'hui sur le compte, {expected} est encore attendu",
  'plan.hero.noSources': "Encore aucune source — ajoutez ce qui finance ce plan.",
  'plan.split.spokenFor': "Déjà affecté",
  'plan.split.notSpokenFor': "Non affecté",
  'plan.split.alreadySpent': "Déjà dépensé",
  'plan.split.overspent': "Dépassement",
  'plan.split.stillLeft': "Encore à dépenser",
  'plan.source.editAria': "Modifier la source {name}",
  'plan.source.removeAria': "Retirer la source {name}",
  'plan.source.inAccount': "sur le compte",
  'plan.source.expected': "attendu",
  'plan.source.noDate': "Pas de date",
  'plan.source.fieldName': "Qu'est-ce que c'est ?",
  'plan.source.fieldKind': "Type",
  'plan.source.fieldKindDesc': "Une étiquette de regroupement seulement — cela ne change rien au calcul.",
  'plan.source.fieldAmount': "Montant",
  'plan.source.fieldDate': "Quand arrive-t-il ?",
  'plan.source.fieldDateDesc': "Une date future compte pour le plan, mais pas pour ce que vous pouvez dépenser aujourd'hui.",
  'plan.source.fieldStatus': "Statut",
  'plan.source.statusReceived': "reçu",
  'plan.source.statusExpected': "attendu",
  'plan.source.fieldNotes': "Notes",
  'plan.source.fieldRemove': "Retirer cette source",
  'plan.source.fieldRemoveYes': "La retirer",
  'plan.env.expandAria': "Déplier {name}",
  'plan.env.leftInBucket': "{amount} restant",
  'plan.env.allSpent': "tout dépensé",
  'plan.env.nothingSpent': "rien dépensé pour l’instant",
  'plan.env.collapseAria': "Replier {name}",
  'plan.env.deleteAria': "Retirer l'enveloppe {name}",
  'plan.actions.deleteAria': "Supprimer le plan",
