...
module.exports = {
  ...
  'acct.deck.why.notx': 'Nothing imports into this account, so nothing can check the figure',
  'acct.deck.do.drift': 'Use {amount}',
  'acct.deck.do.stale': 'Confirm balance',
  'acct.deck.do.nodate': 'Set the date',
  'acct.deck.do.notx': 'Link a folder',
  ...
  'acct.state.notx': 'no transactions',
  ...
  'acct.drawer.recon.notx': 'Nothing imports into this account. Link a transactions folder and the figure becomes checkable.',
