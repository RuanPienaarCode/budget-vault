...
module.exports = {
  ...
  /* ============================ Budget export =============================
     The dialog (bx.*) and the words printed INTO the exported document
     (bx.doc.*). The doc strings that carry {type} {list} {period} {income}
     {spend} {uncat} are filled by src/budget-export.js, not by t() — the view
     hands each placeholder through as itself — so they must keep those names
  ...
  'bx.range.6': '6 months',
  'bx.range.12': '1 year',
  'bx.range.all': 'Everything',
  'bx.includeCurrent': 'Include the current period',
  'bx.includeCurrent.desc': 'It is still in progress, so its figures are for part of a period. Switch off to export finished periods only.',
  'bx.content': 'What to export',
  'bx.content.full': 'Full budget',
  'bx.content.summary': 'Category summary',
  'bx.content.full.desc': 'A month-by-month summary, then every period\'s budget: what was planned, what was spent and what was left, per category.',
  'bx.content.summary.desc': 'One table: what each category came to in each period, with a total, an average and the amount budgeted.',
  'bx.cats': 'Categories',
  'bx.cats.all': 'All categories',
  'bx.cats.pick': 'Choose…',
  'bx.cats.selectAll': 'Select all',
  'bx.cats.selectNone': 'Select none',
  'bx.cats.count': '{count} of {total} selected',
  'bx.includeTx': 'Include the transactions',
  'bx.includeTx.desc': 'Adds the individual transactions behind the figures, for the same periods and categories.',
  'bx.format': 'File type',
  'bx.format.pdf': 'PDF',
  'bx.format.xlsx': 'Excel',
  'bx.format.csv': 'CSV',
  'bx.format.pdf.desc': 'PDF — to read, print or send.',
  'bx.format.xlsx.desc': 'Excel — one workbook with a sheet per table, amounts as real numbers.',
  'bx.format.csv.desc': 'CSV — one plain file per table, for another program.',
  'bx.folder': 'Save to folder',
  'bx.folder.desc': 'A folder in this vault. Exporting the same selection again replaces the earlier files.',
  'bx.cancel': 'Cancel',
  'bx.go': 'Export',
  'bx.preview': {
  ...
  'bx.dirty': 'Save your changes first — an export of unsaved edits would not match the vault',
  'bx.failed': 'Could not write the export ({error}) — check the folder name',
  'bx.failedPartial': {
    one: 'The export stopped after {count} file ({error})',
    other: 'The export stopped after {count} files ({error})',
  },
  'bx.done': {
    one: 'Exported {count} file to {path}/',
    other: 'Exported {count} files to {path}/',
  },
  'bx.done.title': 'Budget exported',
  'bx.done.open': 'Open',
  'bx.done.reveal': 'Show in file explorer',
  'bx.done.close': 'Done',
  'bx.done.hint': 'The files are in your vault. To send one, open it or find it in the file explorer and use your device\'s share or save option.',
  'bx.done.raster': 'Some text in this export uses characters the built-in PDF font cannot draw, so the PDF pages were saved as images. It looks the same, but its text cannot be selected or searched. The Excel and CSV files are not affected.',
  'bx.doc.title': 'Budget',
  'bx.doc.titleSummary': 'Budget summary',
  'bx.doc.category': 'Category',
  'bx.doc.type': 'Type',
  'bx.doc.total': 'Total',
  'bx.doc.average': 'Average',
  'bx.doc.budgeted': 'Budgeted',
  'bx.doc.period': 'Period',
  'bx.doc.from': 'From',
  'bx.doc.to': 'To',
  'bx.doc.budget': 'Budget',
  'bx.doc.actual': 'Actual',
  'bx.doc.remaining': 'Remaining',
  'bx.doc.used': 'Used',
  'bx.doc.notes': 'Notes',
  'bx.doc.date': 'Date',
  'bx.doc.description': 'Description',
  'bx.doc.account': 'Account',
  'bx.doc.currency': 'Currency',
  'bx.doc.amount': 'Amount',
  'bx.doc.flag': 'Flag',
  'bx.doc.excluded': 'excluded',
  'bx.doc.splitParent': 'split parent',
  'bx.doc.splitPart': 'split part',
  'bx.doc.subtotal': 'Total {type}',
  'bx.doc.summaryHeading': 'Summary by category',
  'bx.doc.transactionsHeading': 'Transactions',
  'bx.doc.generated': 'Generated',
  'bx.doc.range': 'Range',
  'bx.doc.categories': 'Categories',
  'bx.doc.allCategories': 'All categories',
  'bx.doc.periodLine': 'Income {income} · Spent {spend}',
  'bx.doc.periodUncat': ' · Uncategorised {uncat}',
  'bx.doc.noteFilter': 'Only these categories are included: {list}. Totals cover the listed categories, not the whole budget.',
  'bx.doc.noteForeign': 'Accounts in {list} are not included in any figure here — there is no exchange rate in this file to combine them with.',
  ...
  'acct.deck.ignore': 'Ignore',
  'acct.deck.ariaIgnore': 'Ignore this warning on {name}',
  'acct.toast.ignored': '{name}: this warning is ignored now. Undo it under Edit.',
  ...
  'acct.deck.show': "Show them",
  'acct.deck.groupReason.drift': "The balance disagrees with the transactions",
  'acct.deck.groupReason.stale': "The balance hasn't been confirmed in a while",
  'acct.deck.groupReason.unreadable': "Some of the transactions have a date nothing can read",
  'acct.deck.groupReason.nodate': "The balance has no readable confirmation date",
  'acct.deck.groupReason.notx': "A folder is linked, but nothing has imported into it yet",
  'acct.deck.groupReason.nofolder': "Nothing imports into these, so nothing can check the figure",
  ...
  'score.flow.overspent.name': "Overspent",
  'score.flow.overspent.sub': "You spent {amount} more than came in",
  ...
  'score.flow.subA.overBudget': "{amount} over budget · {neverBudgeted} never budgeted at all",
  ...
  'assets.hero.totalLabel': "Total value",
  'assets.hero.items': { one: "{count} item", other: "{count} items" },
  'assets.hero.largest': "largest",
  'assets.hero.badgeOk': "every value current",
  'assets.hero.badgeWarn': { one: "{count} needs a new valuation", other: "{count} need a new valuation" },
  'assets.hero.heldAbroad': "plus {list} held abroad, not converted",
  'assets.hero.largestAbroad': "largest abroad {list}, not converted",
  ...
  'plan.hero.partial': "{received} is in the account today, {expected} is still expected",
  'plan.hero.noSources': "No sources yet — add what funds this plan.",
  'plan.split.spokenFor': "Spoken for",
  'plan.split.notSpokenFor': "Not spoken for",
  'plan.split.alreadySpent': "Already spent",
  'plan.split.overspent': "Overspent",
  'plan.split.stillLeft': "Still left to spend",
  'plan.source.editAria': "Edit source {name}",
  'plan.source.removeAria': "Remove source {name}",
  'plan.source.inAccount': "in the account",
  'plan.source.expected': "expected",
  'plan.source.noDate': "No date",
  'plan.source.fieldName': "What is it?",
  'plan.source.fieldKind': "Kind",
  'plan.source.fieldKindDesc': "A label for grouping only — it changes nothing about the arithmetic.",
  'plan.source.fieldAmount': "Amount",
  'plan.source.fieldDate': "When does it land?",
  'plan.source.fieldDateDesc': "A date in the future counts toward the plan, but not toward what you can spend today.",
  'plan.source.fieldStatus': "Status",
  'plan.source.statusReceived': "received",
  'plan.source.statusExpected': "expected",
  'plan.source.fieldNotes': "Notes",
  'plan.source.fieldRemove': "Remove this source",
  'plan.source.fieldRemoveYes': "Remove it",
  'plan.env.expandAria': "Expand {name}",
  'plan.env.leftInBucket': "{amount} left",
  'plan.env.allSpent': "all of it spent",
  'plan.env.nothingSpent': "nothing spent yet",
  'plan.env.collapseAria': "Collapse {name}",
  'plan.env.deleteAria': "Remove spending bucket {name}",
  'plan.actions.deleteAria': "Delete plan",
